...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,890 | 🐛 105 | 📅 2026-08-21
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 7,350 | 🐛 89 | 🌐 Kotlin | 📅 2026-08-28 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,022 | 🐛 133 | 🌐 Swift | 📅 2026-08-18 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 1,932 | 🐛 22 | 🌐 Dart | 📅 2026-08-29 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
...
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 182 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,646 | 🐛 139 | 🌐 C | 📅 2026-08-23
...
* [MicUp](https://github.com/papergray/MicUp) ⭐ 142 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-11 ✨ - Real-time microphone audio processing for Android `MIT`
* [wecho](https://github.com/qumolangmo/wecho) ⭐ 89 | 🐛 0 | 🌐 Dart | 📅 2026-08-28 - An Android application for global audio effects processing `MIT`
* [Volume++](https://github.com/noel-digital-fan/volume_plus_plus) ⭐ 82 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - Custom volume panel with per-app audio mixing via Shizuku or root `MIT`

### Automation

* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,289 | 🐛 340 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [Geto](https://github.com/JackEblan/Geto) ⭐ 1,163 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-29 - Automatically change device settings when a specific app is launched. `GPL-3.0`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,352 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-29 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [Kettu](https://github.com/C0C0B01/Kettu) ⭐ 601 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27 - Discord modding tool. Continuation of the abandoned Bunny-Manager project `BSD-3-Clause`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 2,789 | 🐛 96 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
...
* [ShizuTools](https://github.com/legendsayantan/ShizuTools) ⭐ 2,473 | 🐛 30 | 🌐 Kotlin | 📅 2026-07-28 - Contains some easy-to-use tools to go beyond the level of control allowed by Android System `GPL-3.0`
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,419 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-23 - An application to modify Material You colors of your device `GPL-3.0`
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 116 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-26 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,121 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-28 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
* [DSU-Sideloader](https://github.com/VegaBobo/DSU-Sideloader) ⭐ 2,271 | 🐛 128 | 🌐 Kotlin | 📅 2024-03-13 - A simple app made to help users easily install GSIs via DSU's Android feature. `Apache-2.0`
...
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 718 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [Dextop](https://github.com/NarYuki/Dextop) ⭐ 181 | 🐛 2 | 🌐 Dart | 📅 2026-08-26 - Desktop environment using Samsung DeX or Shizuku with multitasking and custom resolution `GPL-3.0`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,199 | 🐛 723 | 🌐 Kotlin | 📅 2026-08-28 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,119 | 🐛 313 | 🌐 Kotlin | 📅 2026-08-27 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 727 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-28
...
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,392 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-27
* [NFile](https://github.com/Senzme/NFile) ⭐ 382 | 🐛 61 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer with Android TV support. Supports full file access using Shizuku, if enabled in settings `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 182 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28
* [ZenFile](https://github.com/l930203811/ZenFile) ⭐ 122 | 🐛 5 | 🌐 Dart | 📅 2026-08-29 - NFile fork with built-in remote file server support `GPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,617 | 🐛 203 | 🌐 Kotlin | 📅 2026-08-11
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,314 | 🐛 397 | 🌐 Dart | 📅 2026-08-29 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,065 | 🐛 8 | 🌐 Dart | 📅 2026-08-29
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,031 | 🐛 114 | 🌐 Kotlin | 📅 2026-07-29
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,332 | 🐛 195 | 🌐 Kotlin | 📅 2026-08-28
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,363 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 4,945 | 🐛 126 | 🌐 Kotlin | 📅 2026-08-26
...
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,175 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-17 - App store for modded apps `GPL-3.0`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,326 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-29 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 37,351 | 🐛 290 | 🌐 Go | 📅 2026-08-29
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,094 | 🐛 107 | 🌐 Kotlin | 📅 2026-08-28 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,181 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
...
* [de1984](https://github.com/dorumrr/de1984) ⭐ 388 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-28 - App firewall without using an VPN; can also manage packages `MIT`
...
* [Shizzi](https://github.com/carlelieser/shizzi) ⭐ 40 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-22 - Rootless Wi-Fi tethering bypass via Shizuku `Proprietary`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 7,547 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-29
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 3,768 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-23 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
...
* [RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 253 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20 - Advanced reboot menu with Shizuku support `Apache-2.0`
...
* [Curbox](https://f-droid.org/packages/neth.iecal.curbox/) ✨ - Tool to reduce screen addiction and view usage analytics `GPL-3.0` [(Source code)](https://github.com/curbox-app/curbox-android) ⭐ 1,258 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-28
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,560 | 🐛 167 | 🌐 Kotlin | 📅 2026-08-28
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,663 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-24
* [Island](https://play.google.com/store/apps/details?id=com.oasisfeng.island) - Isolate and clone apps for privacy protection and parallel running `Apache-2.0` [(Source code)](https://github.com/oasisfeng/island) ⭐ 3,887 | 🐛 670 | 🌐 Java | 📅 2025-04-24
...
* [Inure App Manager](https://play.google.com/store/apps/details?id=app.simple.inure.play) `15-day trial` `IAP` 💰 - Android app manager for both rooted and non-rooted devices `GPL-3.0` [(Source code)](https://github.com/Hamza417/Inure) ⭐ 1,898 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28
...
* [shappky](https://github.com/YasserNull/shappky) ⭐ 546 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-25 ✨ - A simple app to boost performance by stopping background apps. `GPL-3.0`
...
* [KillMyApps](https://github.com/dedeadend/KillMyApps) ⭐ 71 | 🐛 0 | 🌐 Java | 📅 2026-08-22 - Background process killer to improve battery life and performance via Shizuku or root `GPL-3.0`
...
* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,128 | 🐛 52 | 🌐 Kotlin | 📅 2026-08-28
...
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,243 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-29 - Material You Redesign of aShell app. `GPL-3.0`
...
* [hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) ⭐ 256 | 🐛 27 | 🌐 Kotlin | 📅 2026-08-27 - Pixel 11 HiLight LED controller for custom notification and status light effects `MIT`
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 229 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-24 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 945 | 🐛 404 | 🌐 Kotlin | 📅 2026-08-24 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
