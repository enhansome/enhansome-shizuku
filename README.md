...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,816 | 🐛 105 | 📅 2026-08-21
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 7,343 | 🐛 89 | 🌐 Kotlin | 📅 2026-08-28 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,019 | 🐛 133 | 🌐 Swift | 📅 2026-08-18 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 1,931 | 🐛 23 | 🌐 Dart | 📅 2026-08-28 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
...
* [flicky](https://apt.izzysoft.de/fdroid/index/apk/app.flicky) - An F-Droid client designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/flicky) ⭐ 418 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-24
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 182 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-28
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,645 | 🐛 139 | 🌐 C | 📅 2026-08-23
* [VolumeManager](https://github.com/yume-chan/VolumeManager) ⭐ 543 | 🐛 20 | 🌐 Kotlin | 📅 2026-05-19 - Control each app's volume independently `GPL-2.0`
* [MicUp](https://github.com/papergray/MicUp) ⭐ 141 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-11 ✨ - Real-time microphone audio processing for Android `MIT`
* [wecho](https://github.com/qumolangmo/wecho) ⭐ 90 | 🐛 0 | 🌐 Dart | 📅 2026-08-28 - An Android application for global audio effects processing `MIT`
* [Volume++](https://github.com/noel-digital-fan/volume_plus_plus) ⭐ 81 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-16 - Custom volume panel with per-app audio mixing via Shizuku or root `MIT`

### Automation

* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,289 | 🐛 340 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [Geto](https://github.com/JackEblan/Geto) ⭐ 1,162 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-29 - Automatically change device settings when a specific app is launched. `GPL-3.0`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,349 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-28 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 2,782 | 🐛 95 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
* [AmbientMusicMod](https://github.com/KieronQuinn/AmbientMusicMod) ⭐ 2,496 | 🐛 10 | 🌐 Kotlin | 📅 2024-09-07 - Port of Now Playing from Pixels to other Android devices `GPL-3.0`
* [ShizuTools](https://github.com/legendsayantan/ShizuTools) ⭐ 2,473 | 🐛 29 | 🌐 Kotlin | 📅 2026-07-28 - Contains some easy-to-use tools to go beyond the level of control allowed by Android System `GPL-3.0`
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,415 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-23 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,081 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-07 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
* [System UI Tuner](https://github.com/zacharee/Tweaker) ⭐ 1,719 | 🐛 67 | 🌐 Kotlin | 📅 2026-08-27 - View and modify hidden settings on Android devices `MIT`
...
* [Smart Edge](https://f-droid.org/en/packages/com.imi.smartedge.sidebar.panel/) - A highly customizable Android side panel inspired by OriginOS `MIT` [(Source code)](https://github.com/Imtiaz-Official/Smart-Edge) ⭐ 318 | 🐛 40 | 🌐 Kotlin | 📅 2026-06-13
* [Dragon-Launcher](https://f-droid.org/packages/org.elnix.dragonlauncher/) ✨ - Highly customizable, gestures based Android launcher focused on speed and efficiency `GPL-3.0` [(Source code)](https://github.com/Elnix90/Dragon-Launcher) ⭐ 284 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-28
...
* [CustomAnimator](https://play.google.com/store/apps/details?id=com.arslan.customanimator) - Customize animation speeds on a more fine-grained level `GPL-3.0` [(Source code)](https://github.com/AhmetCanArslan/CustomAnimator) ⭐ 116 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-27
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 112 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-26 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [ShizukuShortcuts](https://github.com/yshalsager/ShizukuShortcuts) ⭐ 60 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-28 - Create launcher shortcuts for shell commands `GPL-3.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,120 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-28 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
* [DSU-Sideloader](https://github.com/VegaBobo/DSU-Sideloader) ⭐ 2,270 | 🐛 128 | 🌐 Kotlin | 📅 2024-03-13 - A simple app made to help users easily install GSIs via DSU's Android feature. `Apache-2.0`
...
* [ActivityManager](https://github.com/sdex/ActivityManager) ⭐ 1,293 | 🐛 14 | 🌐 Kotlin | 📅 2026-07-25 - Launch hidden and unexported activities directly without root `Apache-2.0`
* [LogFox](https://github.com/F0x1d/LogFox) ⭐ 1,286 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-27 ✨ - Yet another logcat reader for Android `GPL-3.0`
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 717 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-21 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [AndroidLowLevelDetector](https://play.google.com/store/apps/details?id=net.imknown.android.forefrontinfo) - Detect Treble, GSI, Mainline, APEX, system-as-root(SAR), A/B, etc. `Apache-2.0` [(Source code)](https://github.com/imknown/AndroidLowLevelDetector) ⭐ 464 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-28
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,751 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-27 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,346 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-26 - Manage your device with Device owner privileges `GPL-3.0`
...
* [Dextop](https://github.com/NarYuki/Dextop) ⭐ 180 | 🐛 2 | 🌐 Dart | 📅 2026-08-26 - Desktop environment using Samsung DeX or Shizuku with multitasking and custom resolution `GPL-3.0`
...
* [Fold\_Switcher](https://github.com/eiyooooo/Fold_Switcher) ⭐ 94 | 🐛 5 | 🌐 Kotlin | 📅 2025-06-10 - Switch between various display folding states on foldable devices `Apache-2.0`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,191 | 🐛 722 | 🌐 Kotlin | 📅 2026-08-28 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,117 | 🐛 313 | 🌐 Kotlin | 📅 2026-08-27 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 726 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-28
* [Aniyomi](https://github.com/aniyomiorg/aniyomi) ⭐ 7,633 | 🐛 375 | 🌐 Kotlin | 📅 2026-08-26 - Tachiyomi fork with anime support and plugin management using Shizuku. `Apache-2.0`
...
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,388 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-27
* [NFile](https://github.com/Senzme/NFile) ⭐ 383 | 🐛 59 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer with Android TV support. Supports full file access using Shizuku, if enabled in settings `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 182 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-28
* [ZenFile](https://github.com/l930203811/ZenFile) ⭐ 122 | 🐛 4 | 🌐 Dart | 📅 2026-08-28 - NFile fork with built-in remote file server support `GPL-3.0`
* [XFiles](https://github.com/Local1stDotApp/XFiles) ⭐ 27 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-15 - Offline file manager with root and Shizuku support for full filesystem access `GPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,616 | 🐛 203 | 🌐 Kotlin | 📅 2026-08-11
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,305 | 🐛 404 | 🌐 Dart | 📅 2026-08-24 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,060 | 🐛 10 | 🌐 Dart | 📅 2026-08-26
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,023 | 🐛 114 | 🌐 Kotlin | 📅 2026-07-29
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,328 | 🐛 195 | 🌐 Kotlin | 📅 2026-08-28
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,362 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 4,944 | 🐛 127 | 🌐 Kotlin | 📅 2026-08-26
...
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,174 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-17 - App store for modded apps `GPL-3.0`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,319 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-23 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
* [instafel](https://github.com/mamiiblt/instafel) ⭐ 1,253 | 🐛 15 | 🌐 Java | 📅 2026-08-21 - Updater app for Instafel, an Instagram mod `MIT`
...
* [ShizuCoreFetch](https://github.com/elhizazi1/ShizuCoreFetch) ⭐ 326 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-27 - Shizuku-powered app manager with silent installs, updates, and batch operations `GPL-3.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 37,351 | 🐛 293 | 🌐 Go | 📅 2026-08-28
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,093 | 🐛 107 | 🌐 Kotlin | 📅 2026-08-28 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,178 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
...
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 574 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-26 - DNS-based ad blocker for Android `MIT`
* [delta](https://github.com/supershadoe/delta) ⭐ 556 | 🐛 17 | 🌐 Kotlin | 📅 2026-05-02 - Hotspot manager using Shizuku `BSD-3-Clause`
* [NetworkSwitch](https://github.com/aunchagaonkar/NetworkSwitch) ⭐ 451 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20 - Android app for 4G/5G network mode switching `GPL-3.0`
* [de1984](https://github.com/dorumrr/de1984) ⭐ 387 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-28 - App firewall without using an VPN; can also manage packages `MIT`
...
* [Shizzi](https://github.com/carlelieser/shizzi) ⭐ 38 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-22 - Rootless Wi-Fi tethering bypass via Shizuku `Proprietary`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 7,544 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-28
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 3,765 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-23 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
* [Universal-ReVanced-Manager](https://github.com/Jman-Github/Universal-ReVanced-Manager) ⭐ 1,285 | 🐛 55 | 🌐 Kotlin | 📅 2026-08-28 - ReVanced patcher that has extra features the official manager doesn't have `GPL-3.0`
...
* [Amply](https://github.com/d4rken-org/amply) ⭐ 29 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-27 - Easy control of charging limits. Temporarily allows one full charge, then automatically restores your protective charge limit `GPL-3.0`
...
* [Amarok-Hider](https://apt.izzysoft.de/fdroid/index/apk/deltazero.amarok.foss) - Hide your private files and Android apps with just one click `Apache-2.0` [(Source code)](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,218 | 🐛 61 | 🌐 Java | 📅 2026-08-11
...
* [PrivacyFlip](https://f-droid.org/packages/io.github.dorumrr.privacyflip/) - Manage your device privacy based on lock/unlock state `MIT` [(Source code)](https://github.com/dorumrr/privacyflip) ⭐ 276 | 🐛 13 | 🌐 Kotlin | 📅 2026-01-22
...
* [Curbox](https://f-droid.org/packages/neth.iecal.curbox/) ✨ - Tool to reduce screen addiction and view usage analytics `GPL-3.0` [(Source code)](https://github.com/curbox-app/curbox-android) ⭐ 1,257 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-28
* [DetoxDroid](https://github.com/flxapps/DetoxDroid) ⭐ 509 | 🐛 53 | 🌐 Kotlin | 📅 2026-07-27 - Digital Detoxing: Use your phone rather than letting your phone use you `GPL-3.0`
...
* [Quick-Tile Settings](https://f-droid.org/packages/com.rbn.qtsettings/) - QS tiles for toggling USB debugging and switching private DNS hosts `GPL-3.0` [(Source code)](https://github.com/RBN-Apps/Quick-Tile-Settings) ⭐ 365 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-27
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,556 | 🐛 167 | 🌐 Kotlin | 📅 2026-08-28
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,659 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-24
* [Island](https://play.google.com/store/apps/details?id=com.oasisfeng.island) - Isolate and clone apps for privacy protection and parallel running `Apache-2.0` [(Source code)](https://github.com/oasisfeng/island) ⭐ 3,886 | 🐛 669 | 🌐 Java | 📅 2025-04-24
* [Blocker](https://github.com/lihenggui/blocker) ⭐ 2,380 | 🐛 44 | 🌐 Kotlin | 📅 2026-08-27 - Enable/disable Android components such as activities, services, receivers, and providers `Apache-2.0`
* [MMRL](https://github.com/MMRLApp/MMRL) ⭐ 2,143 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18 `Root` - Manage your Magisk module repository `GPL-3.0`
* [Inure App Manager](https://play.google.com/store/apps/details?id=app.simple.inure.play) `15-day trial` `IAP` 💰 - Android app manager for both rooted and non-rooted devices `GPL-3.0` [(Source code)](https://github.com/Hamza417/Inure) ⭐ 1,897 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-28
...
* [Package Manager](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager) - A powerful app to manage both system and user apps `GPL-3.0` [(Source code)](https://github.com/SmartPack/PackageManager) ⭐ 815 | 🐛 71 | 🌐 Java | 📅 2026-08-25
* [Thor](https://play.google.com/store/apps/details?id=com.valhalla.thor) - App manager with freeze and install capabilities. `GPL-3.0` [(Source code)](https://github.com/trinadhthatakula/Thor) ⭐ 534 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-28
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 183 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-25 - An app manager focusing on permission management `GPL-3.0`
...
* [shappky](https://github.com/YasserNull/shappky) ⭐ 545 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-25 ✨ - A simple app to boost performance by stopping background apps. `GPL-3.0`
...
* [memhogs](https://github.com/cicerothoma/memhogs-android) ⭐ 46 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-04 - Which apps are eating your phone's memory. Per-app breakdown via Shizuku, helpers grouped under the app that owns them `MIT`

### Terminals

* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,125 | 🐛 52 | 🌐 Kotlin | 📅 2026-08-28
...
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,240 | 🐛 35 | 🌐 Kotlin | 📅 2026-08-28 - Material You Redesign of aShell app. `GPL-3.0`
...
* [pixel-volte-patch](https://github.com/kyujin-cho/pixel-volte-patch/blob/main/README.en.md) ⭐ 2,992 | 🐛 95 | 🌐 Kotlin | 📅 2026-02-07 - Enable VoLTE on Pixel 6 & 7 with LG U+ `GPL-3.0`
...
* [hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) ⭐ 254 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-27 - Pixel 11 HiLight LED controller for custom notification and status light effects `MIT`
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 228 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-24 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [Pixel-IMS-5G](https://github.com/barrylk/Pixel-IMS-5G) ⭐ 29 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-04 - Enable 5G standalone (5G SA) and VoNR on Google Pixel devices `GPL-3.0`

#### Samsung OneUI

* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 944 | 🐛 403 | 🌐 Kotlin | 📅 2026-08-24 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
> \[!NOTE]
> I'm also using an automated crawler that searches for new projects, making use of Shizuku across GitHub and several F-Droid repos. You can view the [current auto-generated crawl report here](https://github.com/timschneeb/app-crawler/blob/master/SUMMARY.md) ⭐ 81 | 🐛 6 | 🌐 Python | 📅 2026-08-28.
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,489 | 🐛 315 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
