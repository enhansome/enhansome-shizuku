...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,228 | 🐛 107 | 📅 2026-09-02
...
* [Shizuku (thedjchi's fork)](https://github.com/thedjchi/Shizuku) ⭐ 5,924 | 🐛 80 | 🌐 Kotlin | 📅 2026-07-15 - Fork of Shizuku with autostart, TCP mode and stealth mode (maintenance currently paused) `Apache-2.0`
* [Stellar](https://github.com/roro2239/Stellar/blob/main/README_en.md) ⭐ 1,464 | 🐛 24 | 🌐 Kotlin | 📅 2026-09-19 - Another Shizuku implementation with autostart, TCP mode and a simple terminal (can run commands automatically on startup) `MPL-2.0`
* [shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 1,170 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-25 ✨ - Material 3 fork with autostart, TCP mode, Dhizuku, module support and a built-in terminal with AI integration `Apache-2.0`
* [ShizukuPlus](https://github.com/thejaustin/ShizukuPlus) ⭐ 1,138 | 🐛 26 | 🌐 Kotlin | 📅 2026-09-25 - Shizuku fork with an extended API surface for developers, autostart, TCP mode, Dhizuku and more `Apache-2.0`
* [Porter](https://github.com/d4rken-org/porter) ⭐ 38 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - Minimal, maintained Shizuku fork that gives apps ADB access with optional root, plus a compatibility companion for Shizuku-only apps `Apache-2.0`
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 8,136 | 🐛 132 | 🌐 Kotlin | 📅 2026-09-22 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,702 | 🐛 205 | 🌐 Swift | 📅 2026-09-01 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [roubao](https://github.com/Turbo1123/roubao/blob/main/README_EN.md) ⭐ 2,365 | 🐛 40 | 🌐 Kotlin | 📅 2026-01-08 - Open-source on-device AI phone automation assistant based on vision-language models that performs tasks via Shizuku system permissions, no PC needed. `MIT` [(Source code)](https://github.com/Turbo1123/roubao) ⭐ 2,365 | 🐛 40 | 🌐 Kotlin | 📅 2026-01-08
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 2,009 | 🐛 28 | 🌐 Dart | 📅 2026-09-25 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
* [ClawGUI](https://github.com/ZJU-REAL/ClawGUI) ⭐ 1,352 | 🐛 7 | 🌐 Python | 📅 2026-06-03 - On-device GUI-agent runner deploying the full ClawGUI brain stack on one phone controlled via Shizuku. `Apache-2.0`
* [OpenDroid](https://github.com/yashab-cyber/opendroid) ⭐ 1,070 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-04 - Open-source autonomous on-device AI agent that plans and executes multi-step tasks via screen automation `Apache-2.0`
...
* [Aether](https://github.com/Zhou-Shilin/Aether) ⭐ 684 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-25 - Localized, extensible general-purpose AI agent for Android, iOS and macOS, with optional Shizuku and Termux integration for direct device control. `GPL-3.0`
...
* [Hermes Agent](https://github.com/adybag14-cyber/hermes-agent) ⭐ 207 | 🐛 4 | 🌐 Python | 📅 2026-09-25 - Hermes Agent port for Android with a Shizuku privileged shell bridge for on-device actions. `MIT`
* [Zafiro](https://github.com/niki914/zafiro) ⭐ 195 | 🐛 33 | 🌐 Kotlin | 📅 2026-09-24 - Bring-your-own-key AI agent that reads the screen and controls the device through Shizuku, without root. `MIT`
* [AndroidHarness](https://github.com/Sanuu7/AndroidHarness) ⭐ 28 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-25 - On-device coding agent that routes privileged commands through a Shizuku shell UID, with a Termux-prefixed Linux toolchain as fallback. `MIT`
...
* [Flywheel](https://github.com/Benjamin-Wiegand/Flywheel) ⭐ 55 | 🐛 2 | 🌐 Java | 📅 2026-08-13 - Free and open source alternative to Android Auto aimed at de-googled phones, compatible with existing headunits; Shizuku is used for app embedding and call-audio capture. `GPL-3.0`

### Android TV

* [flicky](https://apt.izzysoft.de/fdroid/index/apk/app.flicky) - An F-Droid client designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/flicky) ⭐ 430 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-23
...
* [MicUp](https://github.com/papergray/MicUp) ⭐ 165 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-11 ✨ - Real-time microphone audio processing for Android `MIT`
* [Volume++](https://github.com/noel-digital-fan/volume_plus_plus) ⭐ 118 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-22 - Custom volume panel with per-app audio mixing via Shizuku or root `MIT`
...
* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,402 | 🐛 343 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [vFlow](https://github.com/ChaoMixian/vFlow/blob/master/README_EN.md) ⭐ 1,269 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-21 - Visual automation tool that combines tapping, recognition, branching, and system actions into approachable workflows `GPL-2.0`
...
* [IMD](https://github.com/soul-99/SU_IMD) ⭐ 322 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Fork of Geto that hides developer options, ADB, accessibility services and Shizuku itself for restrictive apps like banking, then restores them `GPL-3.0`
...
* [Service-Keeper](https://github.com/shaunkleyn/Service-Keeper) ⭐ 29 | 🐛 0 | 🌐 Dart | 📅 2026-09-24 - Watches background, accessibility and notification-listener services and auto-restarts ones the system kills. `GPL-3.0`
...
* [NexaFlow](https://github.com/Alaa91H/NexaFlow) ⭐ 23 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - Context-aware Android automation engine combining triggers, constraints and actions, with Shizuku execution for privileged device controls. `MIT`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,598 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-23 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [revenge-manager](https://github.com/revenge-mod/revenge-manager) ⭐ 717 | 🐛 16 | 🌐 Kotlin | 📅 2026-01-12 - Discord modding tool. Another continuation of the abandoned Bunny-Manager project `OSL-3.0`
...
* [RivoPhoneApp](https://github.com/user-grinch/RivoPhoneApp) ⭐ 214 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-25 - Material 3 dialer and contacts app with Shizuku-powered call recording without root `GPL-3.0`
...
* [CallVault](https://github.com/madkongo/CallVault) ⭐ 70 | 🐛 9 | 🌐 Kotlin | 📅 2026-09-23 - Non-root call recorder with on-device transcripts/summaries; self-contained over embedded ADB or via an optional Shizuku backend. `GPL-3.0`
...
* [GhostMode](https://github.com/Foxlape/GhostMode) ⭐ 32 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-30 - Makes the phone appear unavailable for incoming calls while keeping LTE/5G data active `Apache-2.0`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 3,105 | 🐛 126 | 🌐 Kotlin | 📅 2026-09-25 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
...
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,472 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-22 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,111 | 🐛 86 | 🌐 Kotlin | 📅 2026-09-18 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
...
* [Lockscreen Widgets](https://play.google.com/store/apps/details?id=tk.zwander.lockscreenwidgets) `IAP` 💰 - Display widgets on the lockscreen. Shizuku is only required on Android 13 and later `MIT` [(Source code)](https://github.com/zacharee/LockscreenWidgets/) ⭐ 561 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-24
...
* [HyperBridge](https://github.com/D4vidDf/HyperBridge) ⭐ 388 | 🐛 56 | 🌐 Kotlin | 📅 2026-09-24 - Brings the native HyperIsland experience to HyperOS by bridging notifications into the camera cutout UI with themes and widgets `Apache-2.0`
* [Dragon-Launcher](https://f-droid.org/packages/org.elnix.dragonlauncher/) ✨ - Highly customizable, gestures based Android launcher focused on speed and efficiency `GPL-3.0` [(Source code)](https://github.com/Elnix90/Dragon-Launcher) ⭐ 306 | 🐛 26 | 🌐 Kotlin | 📅 2026-09-24
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 203 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-20 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [O.status](https://github.com/CATCHINGL/O.status) ⭐ 172 | 🐛 24 | 🌐 Kotlin | 📅 2026-09-15 - Minimal status-bar indicator for Wi-Fi, cellular and battery that uses optional Shizuku integration to match system icon colors. `Proprietary`
* [WidgetsPro](https://github.com/preethamkmr3/WidgetsPro) ⭐ 170 | 🐛 1 | 🌐 Kotlin | 📅 2026-01-20 - CPU and battery widgets `Proprietary`
* [DuoFold-Android](https://github.com/jcx396905-gif/DuoFold-Android) ⭐ 169 | 🐛 4 | 🌐 Java | 📅 2026-09-13 - System-wide iPhone Duo-style fold illusion that reprojects the whole screen from device motion with OpenGL ES, powered by Shizuku. `MIT`
* [expressive-cutout](https://github.com/EvanKoe/expressive-cutout) ⭐ 163 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-22 - Offline Dynamic Island following Material Expressive design with notifications, live tiles, and Material You colors `GPL-3.0`
...
* [ShizukuShortcuts](https://github.com/yshalsager/ShizukuShortcuts) ⭐ 72 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-19 - Create launcher shortcuts for shell commands `GPL-3.0`
* [cebian](https://github.com/qpst4/cebian) ⭐ 69 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-25 - All-in-one gesture and one-hand navigation suite with edge panels, floating cursor, offline OCR ball, app freezer and freeform windows via Shizuku. `AGPL-3.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,188 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-25 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
...
* [ActivityManager](https://github.com/sdex/ActivityManager) ⭐ 1,326 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-25 - Launch hidden and unexported activities directly without root `Apache-2.0`
* [LogFox](https://github.com/F0x1d/LogFox) ⭐ 1,324 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-27 ✨ - Yet another logcat reader for Android `GPL-3.0`
* [Android Code Studio](https://github.com/AndroidCSOfficial/android-code-studio) ⭐ 1,286 | 🐛 327 | 🌐 Java | 📅 2026-07-09 - On-device IDE for building Gradle-based Android projects; Shizuku enables silent installation of the built APK. `GPL-3.0`
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 744 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-19 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [FrameX-Android](https://github.com/MaheshSharan/FrameX-Android) ⭐ 152 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-24 - Real-time performance overlay for Android `MIT`
...
* [ActivityLauncherShizukuPlugin](https://github.com/ActivityLauncher/ActivityLauncherShizukuPlugin) ⭐ 51 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-30 - A Shizuku-based plugin for [Activity Launcher](https://github.com/butzist/ActivityLauncher) ⭐ 1,964 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-14 that allows launching private (non-exported) activities. `GPL-3.0`
...
* [FPS-Meter-Android](https://github.com/rdevz-ph/FPS-Meter-Android) ⭐ 25 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-22 - High-performance lightweight FPS monitoring overlay inspired by Samsung Perf Z for gaming and performance testing `MIT`
* [ADB Captain](https://github.com/eatenlamp/adbcaptain) ⭐ 19 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - ADB toolkit that runs shell commands, app management and log access through Shizuku, with no root required. `AGPL-3.0`
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,868 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-24 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,394 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-23 - Manage your device with Device owner privileges `GPL-3.0`
...
* [Déchaîner](https://github.com/warleysr/dechainer) ⭐ 28 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-20 - Blocks adult content as Device Owner; Shizuku runs the dpm set-device-owner setup command. `Apache-2.0`
...
* [android-display-mirror](https://github.com/jqssun/android-display-mirror) ⭐ 183 | 🐛 14 | 🌐 C++ | 📅 2026-08-24 ✨ - Screen mirroring hub with support for sharing screen content over AirPlay, Moonlight/Sunshine, and DisplayLink `GPL-3.0`
* [android-display-extend](https://github.com/jqssun/android-display-extend) ⭐ 167 | 🐛 7 | 🌐 Java | 📅 2026-07-22 ✨ - Display manager for physical and virtual displays with a built-in virtual touchscreen. Great for use with `scrcpy --new-display` on a PC `GPL-3.0`
...
* [magicdesk](https://github.com/mekhontsev/magicdesk) ⭐ 89 | 🐛 6 | 🌐 Java | 📅 2026-09-22 - Open-source Android 15+ workstation with native windows, external displays, desktops and Termux integration via Shizuku `GPL-3.0`
* [Adaptive-Hz](https://github.com/mahmutaunal/Adaptive-Hz) ⭐ 84 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-14 - Automatically switches display refresh rate between 60Hz and 120Hz based on user interaction. Designed for Samsung devices without true adaptive refresh `MIT`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,820 | 🐛 744 | 🌐 Kotlin | 📅 2026-09-22 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,156 | 🐛 320 | 🌐 Kotlin | 📅 2026-09-20 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 731 | 🐛 23 | 🌐 Kotlin | 📅 2026-09-25
* [Aniyomi](https://github.com/aniyomiorg/aniyomi) ⭐ 7,714 | 🐛 376 | 🌐 Kotlin | 📅 2026-09-14 - Tachiyomi fork with anime support and plugin management using Shizuku. `Apache-2.0`
...
* [MaterialFiles](https://github.com/zhanghai/MaterialFiles) ⭐ 9,061 | 🐛 615 | 🌐 Kotlin | 📅 2026-09-24 - Material Design file manager for Android `GPL-3.0`
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,598 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-25
* [plain-app](https://github.com/plainhub/plain-app) ⭐ 6,779 | 🐛 62 | 🌐 Kotlin | 📅 2026-09-25 - Self-hosted web dashboard to manage files, media, contacts, SMS and calls from a browser, with Shizuku for privileged SMS deletion. `AGPL-3.0`
...
* [Butler](https://github.com/d4rken-org/butler) ⭐ 58 | 🐛 10 | 🌐 Kotlin | 📅 2026-09-25 `IAP` 💰 - Fast, private file explorer for power users with tabs, trash bin, regex search, app manager, and root/Shizuku support `GPL-3.0`
* [XFiles](https://github.com/Local1stDotApp/XFiles) ⭐ 47 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-21 - Offline file manager with root and Shizuku support for full filesystem access `GPL-3.0`
...
* [Buge-Files](https://bugestudio.website/files/) - Material 3 Expressive file manager that installs APKs through Shizuku in addition to storage browsing and management. `GPL-3.0` [(Source code)](https://github.com/BugeStudioTeam/Buge-Files) ⭐ 22 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25
...
* [ROSE](https://github.com/NarayanChetri/ROSE) ⭐ 20 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-25 - Modern file manager with Material 3 UI, archive support, recycle bin and Shizuku access to Android/data and Android/obb without root. `GPL-3.0`
...
* [MAA-Meow](https://github.com/Aliothmoon/MAA-Meow/blob/main/README_EN.md) ⭐ 1,553 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-24 - Run MAA natively on Android for one-click Arknights daily tasks with foreground and background modes `AGPL-3.0`
* [translatefgo](https://github.com/rayshift/translatefgo) ⭐ 340 | 🐛 13 | 🌐 C# | 📅 2026-04-25 - Fate/Grand Order game translation project `MIT`
* [Ascent](https://github.com/4o3F/Ascent) ⭐ 221 | 🐛 0 | 🌐 Dart | 📅 2026-04-22 - A tool for retrieving gacha history links from Mihoyo games  `AGPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,678 | 🐛 184 | 🌐 Kotlin | 📅 2026-09-21
* [BiBi Keyboard](https://github.com/BryceWG/BiBi-Keyboard/blob/main/README_EN.md) ⭐ 806 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-20 - AI-powered voice input method keyboard; Shizuku or root keeps its floating-ball and volume-key background service alive. `Apache-2.0`
...
* [Steam Controller for Android](https://github.com/SonicDX12/SteamController-Android) ⭐ 49 | 🐛 1 | 🌐 Kotlin | 📅 2026-07-16 - Uses the Steam Controller 2026 as a real Android gamepad via Shizuku-backed Linux uinput; USB, dongle or BLE. `MIT`
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,964 | 🐛 384 | 🌐 Dart | 📅 2026-09-13 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,283 | 🐛 11 | 🌐 Dart | 📅 2026-09-25
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,763 | 🐛 96 | 🌐 Kotlin | 📅 2026-09-04
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,480 | 🐛 193 | 🌐 Kotlin | 📅 2026-09-12
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,702 | 🐛 23 | 🌐 Kotlin | 📅 2026-09-25 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 5,218 | 🐛 121 | 🌐 Kotlin | 📅 2026-09-20
...
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,388 | 🐛 80 | 🌐 TypeScript | 📅 2026-09-08 - App store for modded apps `GPL-3.0`
* [InstallWithOptions](https://github.com/zacharee/InstallWithOptions) ⭐ 3,271 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-09 - Simple-ish app using Shizuku to install APKs on-device with advanced options `MIT`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,485 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-16 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
...
* [Vyxel Apps](https://github.com/NikhilKain/vyxel-apps) ⭐ 876 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-24 `IAP` 💰 - GitHub-backed app store with signature verification and silent installs through Shizuku. `AGPL-3.0`
* [PI](https://github.com/SanmerApps/PI) ⭐ 703 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - Package installer that allows overwriting the package requester and executor `MIT`
...
* [Discoverium](https://github.com/cygnusx-1-org/Discoverium) ⭐ 571 | 🐛 10 | 🌐 Dart | 📅 2026-09-22 - Obtainium fork for discovering and installing apps from source, with Shizuku, Dhizuku and Sui install backends. `GPL-3.0`
* [florid](https://github.com/Nandanrmenon/florid) ⭐ 515 | 🐛 49 | 🌐 Dart | 📅 2026-09-07 - Material3 F‑Droid Client `GPL-3.0`
* [KingInstaller](https://github.com/fcaronte/KingInstaller) ⭐ 511 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-24 - APK installer that spoofs the Play Store installer identity to bypass app-visibility restrictions, installing via intents, Shizuku or root `GPL-3.0`
...
* [ShizuStore](https://github.com/timschneeb/ShizuStore) ⭐ 85 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-24 ✨ - App store for Shizuku apps. Based on this awesome-shizuku list and installs APKs straight from their upstream sources `GPL-3.0`
* [APKUpdater](https://github.com/DmitryN71/apkupdater) ⭐ 74 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-24 - APKUpdater fork adding Shizuku-based silent installs next to its APKMirror, Aptoide, F-Droid and IzzyOnDroid sources. `GPL-3.0`
* [multistore](https://github.com/FedeFluork/multistore) ⭐ 31 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-24 - Aggregates third-party app stores into one catalogue to search, compare, download, and update APKs `GPL-3.0`
...
* [kiosk-satellite](https://github.com/jxlarrea/kiosk-satellite) ⭐ 1,266 | 🐛 2 | 🌐 Dart | 📅 2026-09-25 - Home Assistant kiosk: voice satellite, synchronized music and photo screensaver, with Shizuku used for privileged APK updates and device bridging. `Proprietary`
* [overlay-translator](https://github.com/ciddwd/overlay-translator) ⭐ 899 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-19 - Real-time on-screen translator for games, visual novels, and manga with on-device/cloud OCR and floating overlay `Apache-2.0`
* [NekokoLPA2](https://github.com/iebb/NekokoLPA2) ⭐ 380 | 🐛 11 | 🌐 Dart | 📅 2026-09-24 - Cross-platform eSIM/eUICC manager; on Android it asks Shizuku to open the shell-only QRTR socket for Telephony/TMAPI profile operations `MIT`
...
* [OnStop2FinishAndRemoveTask](https://github.com/takusan23/OnStop2FinishAndRemoveTask) ⭐ 90 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-18 - Automatically close selected apps when you exit them to save power and memory `Apache-2.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 38,292 | 🐛 357 | 🌐 Go | 📅 2026-09-24
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,199 | 🐛 119 | 🌐 Kotlin | 📅 2026-09-24 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,282 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-24 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
* [RKNHardering](https://github.com/xtclovver/RKNHardering) ⭐ 1,451 | 🐛 3 | 🌐 Kotlin | 📅 2026-07-26 - Detects VPN/proxy circumvention tooling on-device using community-verified checks, with privileged probes via Shizuku or Root. `AGPL-3.0`
* [Traffic Light](https://play.google.com/store/apps/details?id=com.leekleak.trafficlight) - A persistent network speed tracker in your status bar `GPL-3.0` [(Source code)](https://github.com/leekleak/traffic-light) ⭐ 862 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-25
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 656 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-25 - DNS-based ad blocker for Android `MIT`
...
* [de1984](https://github.com/dorumrr/de1984) ⭐ 429 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-16 - App firewall without using an VPN; can also manage packages `MIT`
...
* [Shizzi](https://github.com/carlelieser/shizzi) ⭐ 110 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-13 - Rootless Wi-Fi tethering bypass via Shizuku `Proprietary`
...
* [NetToggle](https://github.com/Dhangofa/NetToggle) ⭐ 49 | 🐛 1 | 🌐 Java | 📅 2026-09-21 - A lightweight Android Quick Settings tile to force 5G Only, 4G Only and preferred network modes using Root or Shizuku `GPL-3.0`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 8,341 | 🐛 22 | 🌐 Kotlin | 📅 2026-09-25
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 4,003 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-06 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
* [NPatch](https://github.com/7723mod/NPatch) ⭐ 2,368 | 🐛 14 | 🌐 Java | 📅 2026-09-01 - Rootless LSPosed-based Xposed framework that injects the Xposed API into target APKs `GPL-3.0`
* [Universal-ReVanced-Manager](https://github.com/Jman-Github/Universal-ReVanced-Manager) ⭐ 1,309 | 🐛 59 | 🌐 Kotlin | 📅 2026-09-20 - ReVanced patcher that has extra features the official manager doesn't have `GPL-3.0`
...
* [BatStats](https://github.com/mlm-games/BatStats) ⭐ 211 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-21 - Battery monitor with stats via Shizuku `GPL-3.0`
...
* [Battery Mode Checker](https://github.com/mrdarksidetm/Android-Battery-Unrestricted-Checker) ⭐ 14 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-25 - Audit, manage, and toggle Android battery optimization states (Unrestricted, Optimized, Restricted) with Shizuku `Apache-2.0`
...
* [Battery Health Tracker](https://github.com/FrancescoMin/batteryhealthtracker) ⭐ 3 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-24 - Battery health diagnostics and true chemical capacity tracker for Oppo, OnePlus, and Realme devices via Shizuku. `Apache-2.0`
...
* [Amarok-Hider](https://apt.izzysoft.de/fdroid/index/apk/deltazero.amarok.foss) - Hide your private files and Android apps with just one click `Apache-2.0` [(Source code)](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,260 | 🐛 63 | 🌐 Java | 📅 2026-08-11
...
* [Monica](https://github.com/Monica-Pass/Monica) ⭐ 1,032 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-21 - Local-first Bitwarden/KeePass password vault with TOTP; Shizuku keeps autofill protection running in the background. `GPL-3.0`
* [AppLock](https://github.com/aload0/AppLock) ⭐ 886 | 🐛 110 | 🌐 Kotlin | 📅 2026-07-21 ✨ - Lock sensitive apps with a PIN and optionally biometrics `MIT`
* [PrivacyFlip](https://f-droid.org/packages/io.github.dorumrr.privacyflip/) - Manage your device privacy based on lock/unlock state `MIT` [(Source code)](https://github.com/dorumrr/privacyflip) ⭐ 306 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-16
...
* [AppOpsNext](https://github.com/1zumiii/AppOpsNext) ⭐ 48 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - Android 15+ AppOps manager with permission templates, batch changes, install history and diagnostics via Shizuku `Proprietary`
...
* [DetoxDroid](https://github.com/flxapps/DetoxDroid) ⭐ 527 | 🐛 45 | 🌐 Kotlin | 📅 2026-09-22 - Digital Detoxing: Use your phone rather than letting your phone use you `GPL-3.0`
...
* [Blink](https://github.com/character-flat/Blink) ⭐ 24 | 🐛 1 | 🌐 Kotlin | 📅 2026-05-17 - A persistent, highly customizable 20-20-20 rule eye-care timer that uses Shizuku to whitelist itself from Android's battery optimizations `GPL-3.0`
...
* [DNS Toggle](https://f-droid.org/packages/com.ericlowry.dnstoggle/) - Quick Settings tile for Private DNS toggling and configuration, with optional advanced automation. `MIT` [(Source code)](https://github.com/ELowry/DNSToggle) ⭐ 124 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-24
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,761 | 🐛 170 | 🌐 Kotlin | 📅 2026-09-25
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,972 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-17
...
* [Blocker](https://github.com/lihenggui/blocker) ⭐ 2,404 | 🐛 49 | 🌐 Kotlin | 📅 2026-09-21 - Enable/disable Android components such as activities, services, receivers, and providers `Apache-2.0`
...
* [Thor](https://play.google.com/store/apps/details?id=com.valhalla.thor) - App manager with freeze and install capabilities. `GPL-3.0` [(Source code)](https://github.com/trinadhthatakula/Thor) ⭐ 575 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-25
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 263 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-24 - An app manager focusing on permission management `GPL-3.0`
...
* [AppManagerNG](https://github.com/SysAdminDoc/AppManagerNG) ⭐ 96 | 🐛 7 | 🌐 Java | 📅 2026-09-14 - Fork of [AppManager](https://github.com/muntashirakon/appmanager) ⭐ 9,058 | 🐛 197 | 🌐 Java | 📅 2026-09-20 to inspect, debloat, back up, freeze and control Android apps; works with Shizuku, ADB, Dhizuku or root. `GPL-3.0`
...
* [TaskManager](https://github.com/RohitKushvaha01/TaskManager) ⭐ 654 | 🐛 5 | 🌐 C++ | 📅 2026-09-17 - A Task Manager for Android. Killing processes requires root access. `Apache-2.0`
* [shappky](https://github.com/YasserNull/shappky) ⭐ 587 | 🐛 23 | 🌐 Kotlin | 📅 2026-08-25 ✨ - A simple app to boost performance by stopping background apps. `GPL-3.0`
...
* [ReAppzuku](https://github.com/gree1d/ReAppzuku) ⭐ 192 | 🐛 0 | 🌐 Java | 📅 2026-09-20 - Control and manage background applications. Fork of shappky `GPL-3.0`
...
* [KillMyApps](https://github.com/dedeadend/KillMyApps) ⭐ 98 | 🐛 1 | 🌐 Java | 📅 2026-09-15 - Background process killer to improve battery life and performance via Shizuku or root `GPL-3.0`
* [memhogs](https://github.com/cicerothoma/memhogs-android) ⭐ 73 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-24 - Which apps are eating your phone's memory. Per-app breakdown via Shizuku, helpers grouped under the app that owns them `MIT`
...
* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,230 | 🐛 59 | 🌐 Kotlin | 📅 2026-09-25
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,392 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-25 - Material You Redesign of aShell app. `GPL-3.0`
...
* [Smartspacer](https://github.com/KieronQuinn/Smartspacer) ⭐ 3,536 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-29 - Customizable widget, can upgrade the built-in 'At a glance' widget on Pixel devices using Shizuku `GPL-3.0`
...
* [carrier-ims-for-pixel](https://github.com/ryfineZ/carrier-ims-for-pixel) ⭐ 1,746 | 🐛 147 | 🌐 Kotlin | 📅 2026-07-04 - Maintained Pixel IMS toolkit: tune VoLTE/VoWiFi/VoNR, 5G display and carrier config via Shizuku `Apache-2.0`
* [TensorIMS](https://github.com/Pixel-Tailor-CN/TensorIMS) ⭐ 615 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-16 - IMS configuration tool for Tensor Pixel devices; Shizuku applies VoLTE, VoWiFi, VT and VoNR toggles. `Apache-2.0`
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 399 | 🐛 22 | 🌐 Kotlin | 📅 2026-09-13 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) ⭐ 333 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-23 - Pixel 11 HiLight LED controller for custom notification and status light effects `MIT`
...
* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 1,280 | 🐛 543 | 🌐 Kotlin | 📅 2026-09-03 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
* [SamsungRegionOverride](https://github.com/Ritel-T/SamsungRegionOverride) ⭐ 68 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-10 - Temporarily change the SIM region seen by Galaxy Store and other region-locked apps, no root, one-tap restore `MIT`
...
* [IslandRecorder](https://github.com/wxxsfxyzm/IslandRecorder) ⭐ 117 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-29 - Xiaomi-focused screen recorder with Super Island controls `GPL-3.0`
...
* [Aura](https://github.com/tgvdufuture/Aura) ⭐ 8 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - Custom RGB notification LED app for POCO X8 Pro with per-app, per-contact, and per-group colors and animations `MIT`
...
* [panel-assistant](https://github.com/panel-assistant/android) ⭐ 52 | 🐛 20 | 🌐 Kotlin | 📅 2026-09-24 - Home Assistant wall-panel dashboard with entity filtering, MQTT device controls and Shizuku/root-powered provisioning and verified installs. `Apache-2.0`
...
* [Calibrate-SoC](https://github.com/mayusi/Calibrate-SoC) ⭐ 12 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - SoC tuner, monitor and benchmark suite for Android gaming handhelds with goal-seeking governor and live HUD. `Apache-2.0`
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,586 | 🐛 332 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
...
* [Porter API](https://github.com/d4rken-org/porter-api) ⭐ 5 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-25 - Android SDK for Porter, a maintained Shizuku fork, offering compatible Shizuku APIs with direct Porter support `MIT`
