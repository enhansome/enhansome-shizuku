...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,321 | 🐛 105 | 📅 2026-08-21
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 7,393 | 🐛 93 | 🌐 Kotlin | 📅 2026-08-28 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,058 | 🐛 141 | 🌐 Swift | 📅 2026-08-18 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 1,939 | 🐛 23 | 🌐 Dart | 📅 2026-08-29 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
...
* [Mythara](https://github.com/ankurCES/project_mythara) ⭐ 72 | 🐛 2 | 🌐 Kotlin | 📅 2026-05-28 - Open-source local-first agentic AI OS layer for Android. Runs 65+ on-device tools (calls, SMS, calendar, Termux, face recognition); uses Shizuku for cosmetic system tweaks (font scale, dark mode, accent) without root `MIT`
...
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 186 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,649 | 🐛 139 | 🌐 C | 📅 2026-08-23
* [VolumeManager](https://github.com/yume-chan/VolumeManager) ⭐ 544 | 🐛 19 | 🌐 Kotlin | 📅 2026-05-19 - Control each app's volume independently `GPL-2.0`
...
* [Volume++](https://github.com/noel-digital-fan/volume_plus_plus) ⭐ 83 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - Custom volume panel with per-app audio mixing via Shizuku or root `MIT`

### Automation

* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,293 | 🐛 340 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [Geto](https://github.com/JackEblan/Geto) ⭐ 1,166 | 🐛 25 | 🌐 Kotlin | 📅 2026-07-29 - Automatically change device settings when a specific app is launched. `GPL-3.0`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,360 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-29 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [Aliucord-Manager](https://github.com/Aliucord/Manager) ⭐ 672 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-15 - Discord modding tool `OSL-3.0`
* [Kettu](https://github.com/C0C0B01/Kettu) ⭐ 605 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27 - Discord modding tool. Continuation of the abandoned Bunny-Manager project `BSD-3-Clause`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 2,799 | 🐛 102 | 🌐 Kotlin | 📅 2026-08-30 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
...
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,418 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-30 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,084 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-07 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
...
* [Lockscreen Widgets](https://play.google.com/store/apps/details?id=tk.zwander.lockscreenwidgets) `IAP` 💰 - Display widgets on the lockscreen. Shizuku is only required on Android 13 and later `MIT` [(Source code)](https://github.com/zacharee/LockscreenWidgets/) ⭐ 512 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-30
...
* [Smart Edge](https://f-droid.org/en/packages/com.imi.smartedge.sidebar.panel/) - A highly customizable Android side panel inspired by OriginOS `MIT` [(Source code)](https://github.com/Imtiaz-Official/Smart-Edge) ⭐ 319 | 🐛 41 | 🌐 Kotlin | 📅 2026-06-13
* [Dragon-Launcher](https://f-droid.org/packages/org.elnix.dragonlauncher/) ✨ - Highly customizable, gestures based Android launcher focused on speed and efficiency `GPL-3.0` [(Source code)](https://github.com/Elnix90/Dragon-Launcher) ⭐ 287 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-30
* [Adaptive-Theme](https://play.google.com/store/apps/details?id=dev.lexip.hecate) - Smart dark mode based on ambient light `GPL-3.0` [(Source code)](https://github.com/xLexip/Adaptive-Theme) ⭐ 211 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-29
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 125 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [Jarngreipr](https://github.com/BrianJr03/Jarngreipr) ⭐ 99 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-14 - Launcher for dual-screen gaming devices. Uses Shizuku to map on of the touch screens to controller inputs `MIT`
* [DarQ-Reborn](https://github.com/Arora-Sir/DarQ-Reborn) ⭐ 84 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-12 - Per-app selectable force dark option for Android 10 and above `Apache-2.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,121 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-30 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
...
* [KeyAttestation](https://github.com/vvb2060/KeyAttestation) ⭐ 2,095 | 🐛 18 | 🌐 Java | 📅 2025-09-30 - Supports generating, saving, loading, parsing and verifying Android key and ID attestation data. `Proprietary`
* [ActivityManager](https://github.com/sdex/ActivityManager) ⭐ 1,297 | 🐛 14 | 🌐 Kotlin | 📅 2026-07-25 - Launch hidden and unexported activities directly without root `Apache-2.0`
* [LogFox](https://github.com/F0x1d/LogFox) ⭐ 1,289 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-27 ✨ - Yet another logcat reader for Android `GPL-3.0`
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 721 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-21 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [AndroidLowLevelDetector](https://play.google.com/store/apps/details?id=net.imknown.android.forefrontinfo) - Detect Treble, GSI, Mainline, APEX, system-as-root(SAR), A/B, etc. `Apache-2.0` [(Source code)](https://github.com/imknown/AndroidLowLevelDetector) ⭐ 463 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-30
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,757 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-27 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,352 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-26 - Manage your device with Device owner privileges `GPL-3.0`
  * [MDPC](https://github.com/MrRare2/MDPC) ⭐ 116 | 🐛 0 | 🌐 Kotlin | 📅 2026-03-13 - Fork of OwnDroid with added features `GPL-3.0`
* [harbor](https://f-droid.org/packages/com.monstera.harbor/) - Work-profile manager with optional Shizuku tools for automation `Apache-2.0` [(Source code)](https://github.com/Stem0794/harbor) ⭐ 26 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-26
...
* [Dextop](https://github.com/NarYuki/Dextop) ⭐ 183 | 🐛 2 | 🌐 Dart | 📅 2026-08-26 - Desktop environment using Samsung DeX or Shizuku with multitasking and custom resolution `GPL-3.0`
...
* [android-display-mirror](https://github.com/jqssun/android-display-mirror) ⭐ 159 | 🐛 11 | 🌐 C++ | 📅 2026-08-24 ✨ - Screen mirroring hub with support for sharing screen content over AirPlay, Moonlight/Sunshine, and DisplayLink `GPL-3.0`
* [android-display-extend](https://github.com/jqssun/android-display-extend) ⭐ 148 | 🐛 6 | 🌐 Java | 📅 2026-07-22 ✨ - Display manager for physical and virtual displays with a built-in virtual touchscreen. Great for use with `scrcpy --new-display` on a PC `GPL-3.0`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,231 | 🐛 725 | 🌐 Kotlin | 📅 2026-08-29 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,123 | 🐛 313 | 🌐 Kotlin | 📅 2026-08-27 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 728 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-28
...
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,402 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-27
* [NFile](https://github.com/Senzme/NFile) ⭐ 382 | 🐛 62 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer with Android TV support. Supports full file access using Shizuku, if enabled in settings `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 186 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29
* [ZenFile](https://github.com/l930203811/ZenFile) ⭐ 124 | 🐛 5 | 🌐 Dart | 📅 2026-08-29 - NFile fork with built-in remote file server support `GPL-3.0`
* [XFiles](https://github.com/Local1stDotApp/XFiles) ⭐ 30 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-30 - Offline file manager with root and Shizuku support for full filesystem access `GPL-3.0`
...
* [pf-tool](https://github.com/aliernfrog/pf-tool) ⭐ 19 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-30 - Easily import and share Polyfield maps `GPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,619 | 🐛 204 | 🌐 Kotlin | 📅 2026-08-11
* [XtMapper](https://github.com/Xtr126/XtMapper) ⭐ 433 | 🐛 35 | 🌐 Java | 📅 2026-07-18 - Keymapper for Android x86 `GPL-3.0`
* [pastiera](https://github.com/palsoftware/pastiera) ⭐ 191 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-20 - Android keyboard specialized for Physical Keyboard Devices. Uses Shizuku for trackpad gestures `GPL-3.0`
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,347 | 🐛 391 | 🌐 Dart | 📅 2026-08-29 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,078 | 🐛 7 | 🌐 Dart | 📅 2026-08-29
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,075 | 🐛 114 | 🌐 Kotlin | 📅 2026-07-29
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,338 | 🐛 195 | 🌐 Kotlin | 📅 2026-08-28
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,390 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-30 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 4,951 | 🐛 126 | 🌐 Kotlin | 📅 2026-08-26
...
* [InstallWithOptions](https://github.com/zacharee/InstallWithOptions) ⭐ 3,186 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-27 - Simple-ish app using Shizuku to install APKs on-device with advanced options `MIT`
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,186 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-17 - App store for modded apps `GPL-3.0`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,333 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-29 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
...
* [ShizuCoreFetch](https://github.com/elhizazi1/ShizuCoreFetch) ⭐ 331 | 🐛 1 | 🌐 Kotlin | 📅 2026-08-29 - Shizuku-powered app manager with silent installs, updates, and batch operations `GPL-3.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 37,383 | 🐛 292 | 🌐 Go | 📅 2026-08-30
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,097 | 🐛 108 | 🌐 Kotlin | 📅 2026-08-28 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,191 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-28 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
...
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 578 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-30 - DNS-based ad blocker for Android `MIT`
* [delta](https://github.com/supershadoe/delta) ⭐ 556 | 🐛 17 | 🌐 Kotlin | 📅 2026-05-02 - Hotspot manager using Shizuku `BSD-3-Clause`
* [NetworkSwitch](https://github.com/aunchagaonkar/NetworkSwitch) ⭐ 454 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-20 - Android app for 4G/5G network mode switching `GPL-3.0`
* [de1984](https://github.com/dorumrr/de1984) ⭐ 391 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - App firewall without using an VPN; can also manage packages `MIT`
* [wifi-password-manager](https://github.com/Khh-vu/wifi-password-manager) ⭐ 290 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - Simple app using Shizuku to manage & view saved Wi-Fi passwords `MIT`
...
* [Dolphy-App](https://github.com/unvoiddd/Dolphy-App) ⭐ 75 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-26 - NFC, BLE, and IR multi-tool for wireless protocol research `GPL-3.0`
...
* [Shizzi](https://github.com/carlelieser/shizzi) ⭐ 49 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-30 - Rootless Wi-Fi tethering bypass via Shizuku `Proprietary`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 7,598 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-30
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 3,778 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-23 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
...
* [BatStats](https://github.com/mlm-games/BatStats) ⭐ 174 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-30 - Battery monitor with stats via Shizuku `GPL-3.0`
...
* [Amarok-Hider](https://apt.izzysoft.de/fdroid/index/apk/deltazero.amarok.foss) - Hide your private files and Android apps with just one click `Apache-2.0` [(Source code)](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,220 | 🐛 61 | 🌐 Java | 📅 2026-08-11
* [AppLock](https://github.com/aload0/AppLock) ⭐ 850 | 🐛 106 | 🌐 Kotlin | 📅 2026-07-21 ✨ - Lock sensitive apps with a PIN and optionally biometrics `MIT`
...
* [Curbox](https://f-droid.org/packages/neth.iecal.curbox/) ✨ - Tool to reduce screen addiction and view usage analytics `GPL-3.0` [(Source code)](https://github.com/curbox-app/curbox-android) ⭐ 1,268 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-28
...
* [Quick-Tile Settings](https://f-droid.org/packages/com.rbn.qtsettings/) - QS tiles for toggling USB debugging and switching private DNS hosts `GPL-3.0` [(Source code)](https://github.com/RBN-Apps/Quick-Tile-Settings) ⭐ 371 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-27
...
* [DNS Toggle](https://f-droid.org/packages/com.ericlowry.dnstoggle/) - Quick Settings tile for Private DNS toggling and configuration, with optional advanced automation. `MIT` [(Source code)](https://github.com/ELowry/DNSToggle) ⭐ 102 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-30
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,578 | 🐛 167 | 🌐 Kotlin | 📅 2026-08-29
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,688 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-30
...
* [MMRL](https://github.com/MMRLApp/MMRL) ⭐ 2,146 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-18 `Root` - Manage your Magisk module repository `GPL-3.0`
* [Inure App Manager](https://play.google.com/store/apps/details?id=app.simple.inure.play) `15-day trial` `IAP` 💰 - Android app manager for both rooted and non-rooted devices `GPL-3.0` [(Source code)](https://github.com/Hamza417/Inure) ⭐ 1,899 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-29
...
* [Package Manager](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager) - A powerful app to manage both system and user apps `GPL-3.0` [(Source code)](https://github.com/SmartPack/PackageManager) ⭐ 816 | 🐛 71 | 🌐 Java | 📅 2026-08-25
* [Thor](https://play.google.com/store/apps/details?id=com.valhalla.thor) - App manager with freeze and install capabilities. `GPL-3.0` [(Source code)](https://github.com/trinadhthatakula/Thor) ⭐ 535 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-29
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 190 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-30 - An app manager focusing on permission management `GPL-3.0`
...
* [shappky](https://github.com/YasserNull/shappky) ⭐ 548 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-25 ✨ - A simple app to boost performance by stopping background apps. `GPL-3.0`
...
* [Pensum](https://github.com/troikoss/Pensum) ⭐ 178 | 🐛 1 | 🌐 Kotlin | 📅 2026-03-30 ✨ - Windows-style Task Manager for Android `GPL-3.0`
* [ReAppzuku](https://github.com/gree1d/ReAppzuku) ⭐ 169 | 🐛 0 | 🌐 Java | 📅 2026-08-04 - Control and manage background applications. Fork of shappky `GPL-3.0`
* [KillMyApps](https://github.com/dedeadend/KillMyApps) ⭐ 73 | 🐛 0 | 🌐 Java | 📅 2026-08-22 - Background process killer to improve battery life and performance via Shizuku or root `GPL-3.0`
...
* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,132 | 🐛 55 | 🌐 Kotlin | 📅 2026-08-30
...
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,258 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-30 - Material You Redesign of aShell app. `GPL-3.0`
...
* [Smartspacer](https://github.com/KieronQuinn/Smartspacer) ⭐ 3,492 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-29 - Customizable widget, can upgrade the built-in 'At a glance' widget on Pixel devices using Shizuku `GPL-3.0`
* [pixel-volte-patch](https://github.com/kyujin-cho/pixel-volte-patch/blob/main/README.en.md) ⭐ 2,996 | 🐛 95 | 🌐 Kotlin | 📅 2026-02-07 - Enable VoLTE on Pixel 6 & 7 with LG U+ `GPL-3.0`
...
* [hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) ⭐ 269 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-29 - Pixel 11 HiLight LED controller for custom notification and status light effects `MIT`
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 233 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-29 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [Pixel-IMS-5G](https://github.com/barrylk/Pixel-IMS-5G) ⭐ 32 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-04 - Enable 5G standalone (5G SA) and VoNR on Google Pixel devices `GPL-3.0`

#### Samsung OneUI

* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 956 | 🐛 412 | 🌐 Kotlin | 📅 2026-08-24 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
* [ThorVolumeLink](https://github.com/pth2000/ThorVolumeLink) ⭐ 26 | 🐛 1 | 🌐 Java | 📅 2026-08-16 - Synchronized volume control for the dual displays of the AYN Thor `MIT`
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,496 | 🐛 317 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
