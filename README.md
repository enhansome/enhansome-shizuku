...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,894 | 🐛 100 | 📅 2026-06-30
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 6,886 | 🐛 74 | 🌐 Kotlin | 📅 2026-08-15 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
...
* [rish-mcp](https://github.com/turin-dev/rish-mcp) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-15 - Exposes an Android device's Shizuku shell to AIs as an MCP `run_shell` tool over an outbound WebSocket relay — run shell commands from Claude or any MCP client with no VPN, ADB, or sshd `MIT`

### Android TV

* [flicky](https://apt.izzysoft.de/fdroid/index/apk/app.flicky) - An F-Droid client designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/flicky) ⭐ 401 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-10
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,631 | 🐛 135 | 🌐 C | 📅 2026-07-24
* [VolumeManager](https://github.com/yume-chan/VolumeManager) ⭐ 522 | 🐛 16 | 🌐 Kotlin | 📅 2026-05-19 - Control each app's volume independently `GPL-2.0`
...
* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,232 | 🐛 335 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [Geto](https://github.com/JackEblan/Geto) ⭐ 1,110 | 🐛 20 | 🌐 Kotlin | 📅 2026-07-29 - Automatically change device settings when a specific app is launched. `GPL-3.0`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,239 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-14 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
* [CatShare](https://f-droid.org/packages/moe.reimu.catshare/) - Send and receive files over Bluetooth `MIT` [(Source code)](https://github.com/kmod-midori/CatShare) ⭐ 734 | 🐛 14 | 🌐 Kotlin | 📅 2026-02-25
...
* [Aliucord-Manager](https://github.com/Aliucord/Manager) ⭐ 660 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-06 - Discord modding tool `OSL-3.0`
...
* [TapTap](https://github.com/KieronQuinn/TapTap) ⭐ 4,018 | 🐛 16 | 🌐 Kotlin | 📅 2024-10-26 ✨ - Port of the double tap on the back of the device feature from Android 12 to any Android 7.0+ device `GPL-3.0`
* [essentials](https://github.com/sameerasw/essentials) ⭐ 2,617 | 🐛 91 | 🌐 Kotlin | 📅 2026-08-15 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
...
* [ShizuTools](https://github.com/legendsayantan/ShizuTools) ⭐ 2,440 | 🐛 26 | 🌐 Kotlin | 📅 2026-07-28 - Contains some easy-to-use tools to go beyond the level of control allowed by Android System `GPL-3.0`
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,371 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-13 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,058 | 🐛 81 | 🌐 Kotlin | 📅 2026-08-07 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
...
* [Smart Dock](https://f-droid.org/packages/com.axel358.smartdock/) - Transform your phone into a desktop environment with taskbar, recent apps, and start menu `GPL-3.0` [(Source code)](https://github.com/axel358/smartdock) ⭐ 1,393 | 🐛 42 | 🌐 Kotlin | 📅 2026-05-21
* [Taskbar](https://f-droid.org/packages/com.farmerbb.taskbar/) - Use a start menu to access apps. Shizuku can unlock additional features `Apache-2.0` [(Source code)](https://github.com/farmerbb/Taskbar) ⭐ 1,233 | 🐛 207 | 🌐 Java | 📅 2024-11-21
...
* [Extendroid](https://github.com/legendsayantan/Extendroid) ⭐ 665 | 🐛 6 | 🌐 Kotlin | 📅 2026-07-28 ✨ - Adds desktop-like multi-window support on Android for smartphones. `GPL-3.0`
...
* [YoukiDEX](https://github.com/mrYouki/YoukiDex-Android-Desktop) ⭐ 451 | 🐛 3 | 🌐 Kotlin | 📅 2026-04-05 - A full desktop experience layer for Android `GPL-3.0`
...
* [Smart Edge](https://f-droid.org/en/packages/com.imi.smartedge.sidebar.panel/) - A highly customizable Android side panel inspired by OriginOS `MIT` [(Source code)](https://github.com/Imtiaz-Official/Smart-Edge) ⭐ 312 | 🐛 38 | 🌐 Kotlin | 📅 2026-06-13
...
* [Adaptive-Theme](https://play.google.com/store/apps/details?id=dev.lexip.hecate) - Smart dark mode based on ambient light `GPL-3.0` [(Source code)](https://github.com/xLexip/Adaptive-Theme) ⭐ 189 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-12
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 73 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-15 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,096 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-13 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,679 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-13 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,324 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-10 - Manage your device with Device owner privileges `GPL-3.0`
...
* [Grayscaler](https://github.com/C10udburst/Grayscaler) ⭐ 158 | 🐛 6 | 🌐 Kotlin | 📅 2025-02-18 - Keep your phone mostly monochrome, but allow apps like camera to be in color `GPL-3.0`
* [android-display-extend](https://github.com/jqssun/android-display-extend) ⭐ 134 | 🐛 6 | 🌐 Java | 📅 2026-07-22 ✨ - Display manager for physical and virtual displays with a built-in virtual touchscreen. Great for use with `scrcpy --new-display` on a PC `GPL-3.0`
...
* [deskcontrol](https://github.com/exiarepairii/deskcontrol) ⭐ 57 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-08 - Turns your phone into a touchpad and keyboard for a single app running on a wired external display `GPL-3.0`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 22,854 | 🐛 702 | 🌐 Kotlin | 📅 2026-08-14 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,096 | 🐛 310 | 🌐 Kotlin | 📅 2026-08-12 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 722 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-15
* [Aniyomi](https://github.com/aniyomiorg/aniyomi) ⭐ 7,592 | 🐛 371 | 🌐 Kotlin | 📅 2026-08-13 - Tachiyomi fork with anime support and plugin management using Shizuku. `Apache-2.0`
...
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,284 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-15
* [NFile](https://github.com/Senzme/NFile) ⭐ 359 | 🐛 58 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
...
* [ZenFile](https://github.com/l930203811/ZenFile) ⭐ 101 | 🐛 1 | 🌐 Dart | 📅 2026-08-14 - NFile fork with built-in remote file server support `GPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,574 | 🐛 203 | 🌐 Kotlin | 📅 2026-08-11
...
* [keysync](https://github.com/aka-munan/keysync) ⭐ 139 | 🐛 11 | 🌐 Kotlin | 📅 2026-02-26 - Play games using mouse and keyboard on Android device; keymapper for games `Apache-2.0`
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 18,972 | 🐛 393 | 🌐 Dart | 📅 2026-08-10 - Get Android App Updates Directly From the Source `GPL-3.0`
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/OpenHub-Store/GitHub-Store) ⭐ 17,607 | 🐛 102 | 🌐 Kotlin | 📅 2026-07-29
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,259 | 🐛 205 | 🌐 Kotlin | 📅 2026-08-13
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,160 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-15 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 4,900 | 🐛 128 | 🌐 Kotlin | 📅 2026-04-25
* [SAI](https://f-droid.org/packages/com.aefyr.sai.fdroid/) - Android split APKs installer `GPL-3.0` [(Source code)](https://github.com/Aefyr/SAI) ⭐ 3,779 | 🐛 0 | 🌐 Java | 📅 2024-06-03
...
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,072 | 🐛 68 | 🌐 TypeScript | 📅 2026-07-25 - App store for modded apps `GPL-3.0`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,247 | 🐛 17 | 🌐 Kotlin | 📅 2026-08-09 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
* [instafel](https://github.com/mamiiblt/instafel) ⭐ 1,233 | 🐛 11 | 🌐 Java | 📅 2026-08-11 - Updater app for Instafel, an Instagram mod `MIT`
* [ffupdater](https://f-droid.org/packages/de.marmaro.krt.ffupdater/) - FFUpdater: Updater for privacy-friendly browser `GPL-3.0` [(Source code)](https://github.com/Tobi823/ffupdater) ⭐ 1,076 | 🐛 88 | 🌐 Kotlin | 📅 2026-06-27
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 37,002 | 🐛 304 | 🌐 Go | 📅 2026-08-15
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,015 | 🐛 104 | 🌐 Kotlin | 📅 2026-08-15 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,063 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-13 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
* [Traffic Light](https://play.google.com/store/apps/details?id=com.leekleak.trafficlight) - A persistent network speed tracker in your status bar `GPL-3.0` [(Source code)](https://github.com/leekleak/traffic-light) ⭐ 779 | 🐛 19 | 🌐 Kotlin | 📅 2026-08-13
* [delta](https://github.com/supershadoe/delta) ⭐ 551 | 🐛 17 | 🌐 Kotlin | 📅 2026-05-02 - Hotspot manager using Shizuku `BSD-3-Clause`
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 519 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-14 - DNS-based ad blocker for Android `MIT`
* [NetworkSwitch](https://github.com/aunchagaonkar/NetworkSwitch) ⭐ 419 | 🐛 21 | 🌐 Kotlin | 📅 2026-07-08 - Android app for 4G/5G network mode switching `GPL-3.0`
...
* [NetToggle](https://github.com/Dhangofa/NetToggle) ⭐ 20 | 🐛 2 | 🌐 Java | 📅 2026-08-14 - A lightweight Android Quick Settings tile to force 5G Only, 4G Only and preferred network modes using Root or Shizuku `GPL-3.0`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 7,124 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-15
...
* [Universal-ReVanced-Manager](https://github.com/Jman-Github/Universal-ReVanced-Manager) ⭐ 1,252 | 🐛 50 | 🌐 Kotlin | 📅 2026-08-14 - ReVanced patcher that has extra features the official manager doesn't have `GPL-3.0`
...
* [Battery-Monitor](https://github.com/tswistak/Battery-Monitor) ⭐ 54 | 🐛 40 | 🌐 Kotlin | 📅 2026-08-14 - Track and log battery capacity and parameters over time using Shizuku `GPL-3.0`
...
* [Amply](https://github.com/d4rken-org/amply) ⭐ 15 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-15 - Easy control of charging limits. Temporarily allows one full charge, then automatically restores your protective charge limit `GPL-3.0`
* [Batt](https://gitlab.com/narektor/batt) - A simple app that shows battery status information on Android 14 and later. `GPL-3.0`

### Privacy

* [Amarok-Hider](https://apt.izzysoft.de/fdroid/index/apk/deltazero.amarok.foss) - Hide your private files and Android apps with just one click `Apache-2.0` [(Source code)](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,188 | 🐛 62 | 🌐 Java | 📅 2026-08-11
* [AppLock](https://github.com/aload0/AppLock) ⭐ 829 | 🐛 104 | 🌐 Kotlin | 📅 2026-07-21 ✨ - Lock sensitive apps with a PIN and optionally biometrics `MIT`
...
* [PrivateDNSAndroid](https://github.com/karasevm/PrivateDNSAndroid) ⭐ 1,016 | 🐛 11 | 🌐 Kotlin | 📅 2026-07-29 - Quick settings tile to switch active private DNS server `MIT`
...
* [DNS Toggle](https://f-droid.org/packages/com.ericlowry.dnstoggle/) - Quick Settings tile for Private DNS toggling and configuration, with optional advanced automation. `MIT` [(Source code)](https://github.com/ELowry/DNSToggle) ⭐ 90 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-09
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,442 | 🐛 167 | 🌐 Kotlin | 📅 2026-08-12
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,548 | 🐛 29 | 🌐 Kotlin | 📅 2026-08-15
* [Island](https://play.google.com/store/apps/details?id=com.oasisfeng.island) - Isolate and clone apps for privacy protection and parallel running `Apache-2.0` [(Source code)](https://github.com/oasisfeng/island) ⭐ 3,872 | 🐛 664 | 🌐 Java | 📅 2025-04-24
* [Blocker](https://github.com/lihenggui/blocker) ⭐ 2,356 | 🐛 51 | 🌐 Kotlin | 📅 2026-08-03 - Enable/disable Android components such as activities, services, receivers, and providers `Apache-2.0`
* [MMRL](https://github.com/MMRLApp/MMRL) ⭐ 2,125 | 🐛 8 | 🌐 Kotlin | 📅 2026-07-10 `Root` - Manage your Magisk module repository `GPL-3.0`
* [Inure App Manager](https://play.google.com/store/apps/details?id=app.simple.inure.play) `15-day trial` `IAP` 💰 - Android app manager for both rooted and non-rooted devices `GPL-3.0` [(Source code)](https://github.com/Hamza417/Inure) ⭐ 1,875 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-13
* [UpgradeAll](https://f-droid.org/packages/net.xzos.upgradeall/) - Check updates for Android apps, Magisk modules and more! `GPL-3.0` [(Source code)](https://github.com/DUpdateSystem/UpgradeAll) ⭐ 1,328 | 🐛 41 | 🌐 Kotlin | 📅 2026-08-07
...
* [Thor](https://play.google.com/store/apps/details?id=com.valhalla.thor) - App manager with freeze and install capabilities. `GPL-3.0` [(Source code)](https://github.com/trinadhthatakula/Thor) ⭐ 512 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-15
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 151 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-15 - An app manager focusing on permission management `GPL-3.0`
...
* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassOnTin/Haven) ⭐ 1,045 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-15
...
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,185 | 🐛 34 | 🌐 Kotlin | 📅 2026-08-15 - Material You Redesign of aShell app. `GPL-3.0`
...
* [Smartspacer](https://github.com/KieronQuinn/Smartspacer) ⭐ 3,471 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-08 - Customizable widget, can upgrade the built-in 'At a glance' widget on Pixel devices using Shizuku `GPL-3.0`
...
* [TurboIMS](https://github.com/Turbo1123/TurboIMS) ⭐ 358 | 🐛 5 | 🌐 Java | 📅 2025-10-17 - Enhanced IMS Configuration Tool for Google Pixel devices `Apache-2.0`
...
* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 816 | 🐛 360 | 🌐 Kotlin | 📅 2026-08-09 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
> \[!NOTE]
> I'm also using an automated crawler that searches for new projects, making use of Shizuku across GitHub and several F-Droid repos. You can view the [current auto-generated crawl report here](https://github.com/timschneeb/app-crawler/blob/master/SUMMARY.md) ⭐ 77 | 🐛 5 | 🌐 Python | 📅 2026-08-14.
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,446 | 🐛 299 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
