...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,479 | 🐛 106 | 📅 2026-09-02
...
* [Shizuku (thedjchi's fork)](https://github.com/thedjchi/Shizuku) ⭐ 5,858 | 🐛 79 | 🌐 Kotlin | 📅 2026-07-15 - Fork of Shizuku with autostart, TCP mode and stealth mode (maintenance currently paused) `Apache-2.0`
* [Stellar](https://github.com/roro2239/Stellar/blob/main/README_en.md) ⭐ 1,434 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-19 - Another Shizuku implementation with autostart, TCP mode and a simple terminal (can run commands automatically on startup) `MPL-2.0`
* [shevery](https://github.com/HmnDev-Tech/shevery) ⭐ 1,128 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-20 ✨ - Material 3 fork with autostart, TCP mode, Dhizuku, module support and a built-in terminal with AI integration `Apache-2.0`
* [ShizukuPlus](https://github.com/thejaustin/ShizukuPlus) ⭐ 1,082 | 🐛 35 | 🌐 Kotlin | 📅 2026-09-19 - Shizuku fork with an extended API surface for developers, autostart, TCP mode, Dhizuku and more `Apache-2.0`
* [Porter](https://github.com/d4rken-org/porter) ⭐ 26 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-21 - Minimal, maintained Shizuku fork that gives apps ADB access with optional root, plus a compatibility companion for Shizuku-only apps `Apache-2.0`
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 8,046 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-20 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,589 | 🐛 218 | 🌐 Swift | 📅 2026-09-01 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [roubao](https://github.com/Turbo1123/roubao/blob/main/README_EN.md) ⭐ 2,361 | 🐛 40 | 🌐 Kotlin | 📅 2026-01-08 - Open-source on-device AI phone automation assistant based on vision-language models that performs tasks via Shizuku system permissions, no PC needed. `MIT` [(Source code)](https://github.com/Turbo1123/roubao) ⭐ 2,361 | 🐛 40 | 🌐 Kotlin | 📅 2026-01-08
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 2,002 | 🐛 26 | 🌐 Dart | 📅 2026-09-20 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
* [ClawGUI](https://github.com/ZJU-REAL/ClawGUI) ⭐ 1,349 | 🐛 7 | 🌐 Python | 📅 2026-06-03 - On-device GUI-agent runner deploying the full ClawGUI brain stack on one phone controlled via Shizuku. `Apache-2.0`
* [OpenDroid](https://github.com/yashab-cyber/opendroid) ⭐ 1,064 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-04 - Open-source autonomous on-device AI agent that plans and executes multi-step tasks via screen automation `Apache-2.0`
...
* [Aether](https://github.com/Zhou-Shilin/Aether) ⭐ 667 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-19 - Localized, extensible general-purpose AI agent for Android, iOS and macOS, with optional Shizuku and Termux integration for direct device control. `GPL-3.0`
* [OpenCyvis](https://github.com/opencyvis/opencyvis-phone) ⭐ 402 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-19 - Open-source AI phone that sees your screen and operates apps from natural language tasks, works in the background `Apache-2.0`
...
* [Flywheel](https://github.com/Benjamin-Wiegand/Flywheel) ⭐ 47 | 🐛 1 | 🌐 Java | 📅 2026-08-13 - Free and open source alternative to Android Auto aimed at de-googled phones, compatible with existing headunits; Shizuku is used for app embedding and call-audio capture. `GPL-3.0`

### Android TV

* [flicky](https://apt.izzysoft.de/fdroid/index/apk/app.flicky) - An F-Droid client designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/flicky) ⭐ 428 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-18
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 202 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-14
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,674 | 🐛 141 | 🌐 C | 📅 2026-08-31
...
* [Volume++](https://github.com/noel-digital-fan/volume_plus_plus) ⭐ 118 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-29 - Custom volume panel with per-app audio mixing via Shizuku or root `MIT`
...
* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,386 | 🐛 343 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
...
* [IMD](https://github.com/soul-99/SU_IMD) ⭐ 313 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - Fork of Geto that hides developer options, ADB, accessibility services and Shizuku itself for restrictive apps like banking, then restores them `GPL-3.0`
...
* [OpenTasker](https://github.com/SysAdminDoc/OpenTasker) ⭐ 87 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-14 - Local-first, open-source Tasker alternative with readable rules and honest permission gates; privileged actions run through a Shizuku AIDL user service. `MIT`
...
* [Service-Keeper](https://github.com/shaunkleyn/Service-Keeper) ⭐ 25 | 🐛 0 | 🌐 Dart | 📅 2026-09-10 - Watches background, accessibility and notification-listener services and auto-restarts ones the system kills. `GPL-3.0`
...
* [Nothing\_Modes](https://github.com/Dvorinka/Nothing_Modes) ⭐ 3 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-20 - Automation app for Nothing phones (modes, routines, Glyph) that also runs on other Android devices with optional Shizuku `GPL-3.0`

### Communication

* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,553 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-20 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [CatShare](https://f-droid.org/packages/moe.reimu.catshare/) - Send and receive files over Bluetooth `MIT` [(Source code)](https://github.com/kmod-midori/CatShare) ⭐ 749 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-17
* [revenge-manager](https://github.com/revenge-mod/revenge-manager) ⭐ 713 | 🐛 17 | 🌐 Kotlin | 📅 2026-01-12 - Discord modding tool. Another continuation of the abandoned Bunny-Manager project `OSL-3.0`
* [Aliucord-Manager](https://github.com/Aliucord/Manager) ⭐ 684 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-19 - Discord modding tool `OSL-3.0`
* [RivoPhoneApp](https://github.com/user-grinch/RivoPhoneApp) ⭐ 206 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-21 - Material 3 dialer and contacts app with Shizuku-powered call recording without root `GPL-3.0`
...
* [CallVault](https://github.com/madkongo/CallVault) ⭐ 66 | 🐛 9 | 🌐 Kotlin | 📅 2026-09-19 - Non-root call recorder with on-device transcripts/summaries; self-contained over embedded ADB or via an optional Shizuku backend. `GPL-3.0`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 3,064 | 🐛 115 | 🌐 Kotlin | 📅 2026-09-21 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
* [ShizuTools](https://github.com/legendsayantan/ShizuTools) ⭐ 2,539 | 🐛 30 | 🌐 Kotlin | 📅 2026-07-28 - Contains some easy-to-use tools to go beyond the level of control allowed by Android System `GPL-3.0`
* [AmbientMusicMod](https://github.com/KieronQuinn/AmbientMusicMod) ⭐ 2,512 | 🐛 10 | 🌐 Kotlin | 📅 2024-09-07 - Port of Now Playing from Pixels to other Android devices `GPL-3.0`
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,463 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-19 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,109 | 🐛 86 | 🌐 Kotlin | 📅 2026-09-18 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
...
* [Extendroid](https://github.com/legendsayantan/Extendroid) ⭐ 691 | 🐛 11 | 🌐 Kotlin | 📅 2026-07-28 ✨ - Adds desktop-like multi-window support on Android for smartphones. `GPL-3.0`
...
* [gama](https://github.com/palincat/gama) ⭐ 406 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-19 - Can switch between OpenGL and Vulkan renderers by setting the `debug.hwui.renderer` system property `MIT`
* [DroidOS](https://github.com/Katsuyamaki/DroidOS) ⭐ 399 | 🐛 11 | 🌐 Kotlin | 📅 2026-05-04 ✨ - Tiling window manager, Samsung DEX replacement, popup app launcher `Proprietary`
* [Smart Edge](https://f-droid.org/en/packages/com.imi.smartedge.sidebar.panel/) - A highly customizable Android side panel inspired by OriginOS `MIT` [(Source code)](https://github.com/Imtiaz-Official/Smart-Edge) ⭐ 392 | 🐛 46 | 🌐 Kotlin | 📅 2026-06-13
* [HyperBridge](https://github.com/D4vidDf/HyperBridge) ⭐ 382 | 🐛 66 | 🌐 Kotlin | 📅 2026-09-21 - Brings the native HyperIsland experience to HyperOS by bridging notifications into the camera cutout UI with themes and widgets `Apache-2.0`
...
* [Adaptive-Theme](https://play.google.com/store/apps/details?id=dev.lexip.hecate) - Smart dark mode based on ambient light `GPL-3.0` [(Source code)](https://github.com/xLexip/Adaptive-Theme) ⭐ 262 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-20
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 189 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-20 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [O.status](https://github.com/CATCHINGL/O.status) ⭐ 163 | 🐛 22 | 🌐 Kotlin | 📅 2026-09-15 - Minimal status-bar indicator for Wi-Fi, cellular and battery that uses optional Shizuku integration to match system icon colors. `Proprietary`
* [expressive-cutout](https://github.com/EvanKoe/expressive-cutout) ⭐ 160 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-16 - Offline Dynamic Island following Material Expressive design with notifications, live tiles, and Material You colors `GPL-3.0`
* [CustomAnimator](https://play.google.com/store/apps/details?id=com.arslan.customanimator) - Customize animation speeds on a more fine-grained level `GPL-3.0` [(Source code)](https://github.com/AhmetCanArslan/CustomAnimator) ⭐ 127 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-17
...
* [cebian](https://github.com/qpst4/cebian) ⭐ 61 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-21 - All-in-one gesture and one-hand navigation suite with edge panels, floating cursor, offline OCR ball, app freezer and freeform windows via Shizuku. `AGPL-3.0`
...
* [Commander](https://github.com/astroboii47/Commander) ⭐ 17 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-09 - Keyboard-first command bar and notification hub; uses Shizuku for recent-app switching and privileged shell controls. `MIT`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,180 | 🐛 15 | 🌐 Kotlin | 📅 2026-09-21 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
* [DSU-Sideloader](https://github.com/VegaBobo/DSU-Sideloader) ⭐ 2,295 | 🐛 128 | 🌐 Kotlin | 📅 2024-03-13 - A simple app made to help users easily install GSIs via DSU's Android feature. `Apache-2.0`
...
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 739 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-19 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [FrameX-Android](https://github.com/MaheshSharan/FrameX-Android) ⭐ 149 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-21 - Real-time performance overlay for Android `MIT`
* [80bee-app](https://github.com/Endda/80bee-app) ⭐ 88 | 🐛 4 | 🌐 Kotlin | 📅 2026-07-10 - Root-free on-device ADB/Fastboot toolbox: boot modes, DPI, DNS, debloater and sideload bypass via Shizuku, plus USB-OTG host mode. `Apache-2.0`
...
* [ActivityLauncherShizukuPlugin](https://github.com/ActivityLauncher/ActivityLauncherShizukuPlugin) ⭐ 50 | 🐛 2 | 🌐 Kotlin | 📅 2026-06-30 - A Shizuku-based plugin for [Activity Launcher](https://github.com/butzist/ActivityLauncher) ⭐ 1,957 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-14 that allows launching private (non-exported) activities. `GPL-3.0`
...
* [FPS-Meter-Android](https://github.com/rdevz-ph/FPS-Meter-Android) ⭐ 23 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - High-performance lightweight FPS monitoring overlay inspired by Samsung Perf Z for gaming and performance testing `MIT`
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,849 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-21 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,390 | 🐛 16 | 🌐 Kotlin | 📅 2026-09-19 - Manage your device with Device owner privileges `GPL-3.0`
...
* [Dextop](https://github.com/NarYuki/Dextop) ⭐ 279 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-15 - Desktop environment using Samsung DeX or Shizuku with multitasking and custom resolution `GPL-3.0`
...
* [android-display-extend](https://github.com/jqssun/android-display-extend) ⭐ 164 | 🐛 7 | 🌐 Java | 📅 2026-07-22 ✨ - Display manager for physical and virtual displays with a built-in virtual touchscreen. Great for use with `scrcpy --new-display` on a PC `GPL-3.0`
...
* [magicdesk](https://github.com/mekhontsev/magicdesk) ⭐ 61 | 🐛 6 | 🌐 Java | 📅 2026-09-20 - Open-source Android 15+ workstation with native windows, external displays, desktops and Termux integration via Shizuku `GPL-3.0`
* [Tideo Auto Brightness](https://github.com/faded-penguin021/Tideo-Auto-Brightness) ⭐ 42 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-21 - Glass-box adaptive-brightness replacement with explainable decisions and circadian support. `MIT`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,731 | 🐛 738 | 🌐 Kotlin | 📅 2026-09-20 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
...
* [Aniyomi](https://github.com/aniyomiorg/aniyomi) ⭐ 7,698 | 🐛 376 | 🌐 Kotlin | 📅 2026-09-14 - Tachiyomi fork with anime support and plugin management using Shizuku. `Apache-2.0`
* [hlbmerge\_flutter](https://github.com/molihuan/hlbmerge_flutter) ⭐ 381 | 🐛 4 | 🌐 Dart | 📅 2026-09-14 - Merge and export BiliBili cache files into MP4, supports mobile and computer client `Apache-2.0`
...
* [MaterialFiles](https://github.com/zhanghai/MaterialFiles) ⭐ 9,013 | 🐛 611 | 🌐 Kotlin | 📅 2026-09-20 - Material Design file manager for Android `GPL-3.0`
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,568 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-21
* [plain-app](https://github.com/plainhub/plain-app) ⭐ 6,745 | 🐛 62 | 🌐 Kotlin | 📅 2026-09-20 - Self-hosted web dashboard to manage files, media, contacts, SMS and calls from a browser, with Shizuku for privileged SMS deletion. `AGPL-3.0`
* [NFile](https://github.com/Senzme/NFile) ⭐ 411 | 🐛 60 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer with Android TV support. Supports full file access using Shizuku, if enabled in settings `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 202 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-14
...
* [ZenFile](https://github.com/l930203811/ZenFile) ⭐ 153 | 🐛 7 | 🌐 Dart | 📅 2026-09-21 - NFile fork with built-in remote file server support `GPL-3.0`
...
* [XFiles](https://github.com/Local1stDotApp/XFiles) ⭐ 47 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-21 - Offline file manager with root and Shizuku support for full filesystem access `GPL-3.0`
...
* [Buge-Files](https://bugestudio.website/files/) - Material 3 Expressive file manager that installs APKs through Shizuku in addition to storage browsing and management. `GPL-3.0` [(Source code)](https://github.com/BugeStudioTeam/Buge-Files) ⭐ 17 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-20
...
* [MAA-Meow](https://github.com/Aliothmoon/MAA-Meow/blob/main/README_EN.md) ⭐ 1,536 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-20 - Run MAA natively on Android for one-click Arknights daily tasks with foreground and background modes `AGPL-3.0`
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,666 | 🐛 183 | 🌐 Kotlin | 📅 2026-09-21
* [BiBi Keyboard](https://github.com/BryceWG/BiBi-Keyboard/blob/main/README_EN.md) ⭐ 800 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-20 - AI-powered voice input method keyboard; Shizuku or root keeps its floating-ball and volume-key background service alive. `Apache-2.0`
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,849 | 🐛 378 | 🌐 Dart | 📅 2026-09-13 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,248 | 🐛 7 | 🌐 Dart | 📅 2026-09-20
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,655 | 🐛 94 | 🌐 Kotlin | 📅 2026-09-04
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,451 | 🐛 192 | 🌐 Kotlin | 📅 2026-09-12
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,664 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-20 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 5,166 | 🐛 119 | 🌐 Kotlin | 📅 2026-09-20
* [SAI](https://f-droid.org/packages/com.aefyr.sai.fdroid/) - Android split APKs installer `GPL-3.0` [(Source code)](https://github.com/Aefyr/SAI) ⭐ 3,862 | 🐛 0 | 🌐 Java | 📅 2024-06-03
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,362 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-08 - App store for modded apps `GPL-3.0`
* [InstallWithOptions](https://github.com/zacharee/InstallWithOptions) ⭐ 3,266 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-09 - Simple-ish app using Shizuku to install APKs on-device with advanced options `MIT`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,471 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-16 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
* [instafel](https://github.com/mamiiblt/instafel) ⭐ 1,263 | 🐛 15 | 🌐 Java | 📅 2026-09-16 - Updater app for Instafel, an Instagram mod `MIT`
...
* [ShizuCoreFetch](https://github.com/elhizazi1/ShizuCoreFetch) ⭐ 445 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-15 - Shizuku-powered app manager with silent installs, updates, and batch operations `GPL-3.0`
* [BHub](https://github.com/B1ays/BHub) ⭐ 359 | 🐛 4 | 🌐 Kotlin | 📅 2025-10-01 - Download, install and share mods easily `Proprietary`
* [ShizuStore](https://github.com/timschneeb/ShizuStore) ⭐ 40 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 ✨ - App store for Shizuku apps. Based on this awesome-shizuku list and installs APKs straight from their upstream sources `GPL-3.0`
...
* [kiosk-satellite](https://github.com/jxlarrea/kiosk-satellite) ⭐ 1,163 | 🐛 0 | 🌐 Dart | 📅 2026-09-21 - Home Assistant kiosk: voice satellite, synchronized music and photo screensaver, with Shizuku used for privileged APK updates and device bridging. `Proprietary`
* [overlay-translator](https://github.com/ciddwd/overlay-translator) ⭐ 876 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-19 - Real-time on-screen translator for games, visual novels, and manga with on-device/cloud OCR and floating overlay `Apache-2.0`
* [NekokoLPA2](https://github.com/iebb/NekokoLPA2) ⭐ 366 | 🐛 12 | 🌐 Dart | 📅 2026-09-14 - Cross-platform eSIM/eUICC manager; on Android it asks Shizuku to open the shell-only QRTR socket for Telephony/TMAPI profile operations `MIT`
...
* [AppBooster](https://github.com/androidexpert35/AppBooster) ⭐ 109 | 🐛 9 | 🌐 Kotlin | 📅 2026-07-20 - GUI for Android's builtin `dex2oat` utility, allowing DEX code of installed apps to be re-optimized `Apache-2.0`
* [OnStop2FinishAndRemoveTask](https://github.com/takusan23/OnStop2FinishAndRemoveTask) ⭐ 88 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-18 - Automatically close selected apps when you exit them to save power and memory `Apache-2.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 38,191 | 🐛 348 | 🌐 Go | 📅 2026-09-21
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,184 | 🐛 116 | 🌐 Kotlin | 📅 2026-09-21 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,271 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-21 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
...
* [Traffic Light](https://play.google.com/store/apps/details?id=com.leekleak.trafficlight) - A persistent network speed tracker in your status bar `GPL-3.0` [(Source code)](https://github.com/leekleak/traffic-light) ⭐ 860 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-18
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 641 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-21 - DNS-based ad blocker for Android `MIT`
* [delta](https://github.com/supershadoe/delta) ⭐ 566 | 🐛 17 | 🌐 Kotlin | 📅 2026-05-02 - Hotspot manager using Shizuku `BSD-3-Clause`
* [NetworkSwitch](https://github.com/aunchagaonkar/NetworkSwitch) ⭐ 468 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-20 - Android app for 4G/5G network mode switching `GPL-3.0`
...
* [NetToggle](https://github.com/Dhangofa/NetToggle) ⭐ 46 | 🐛 1 | 🌐 Java | 📅 2026-09-21 - A lightweight Android Quick Settings tile to force 5G Only, 4G Only and preferred network modes using Root or Shizuku `GPL-3.0`
* [NetManager](https://github.com/DottoXD/NetManager) ⭐ 23 | 🐛 0 | 🌐 Dart | 📅 2026-09-21 - Material cell-network monitor for 4G/5G NR with tower map, drive tests and speed tests; a Shizuku shell bridge unlocks extra network data. `GPL-3.0`
* [hikari-adblock](https://github.com/codegeasse1/hikari-adblock) ⭐ 16 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-11 - No-root ad/tracker/malware blocker with local VPN DNS filter plus Shizuku iptables/nftables firewall modes `GPL-3.0`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 8,219 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-21
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 3,965 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-06 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
* [NPatch](https://github.com/7723mod/NPatch) ⭐ 2,341 | 🐛 17 | 🌐 Java | 📅 2026-09-01 - Rootless LSPosed-based Xposed framework that injects the Xposed API into target APKs `GPL-3.0`
...
* [NoMoreBackground](https://f-droid.org/packages/com.adilhanney.no_more_background/) - A fire-and-forget program to stop Android apps from running in the background `GPL-3.0` [(Source code)](https://github.com/adil192/no_more_background) ⭐ 345 | 🐛 11 | 🌐 Dart | 📅 2026-09-01
...
* [BatStats](https://github.com/mlm-games/BatStats) ⭐ 205 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-21 - Battery monitor with stats via Shizuku `GPL-3.0`
...
* [Battery Mode Checker](https://github.com/mrdarksidetm/Android-Battery-Unrestricted-Checker) ⭐ 5 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-20 - Audit, manage, and toggle Android battery optimization states (Unrestricted, Optimized, Restricted) with Shizuku `Apache-2.0`
...
* [Monica](https://github.com/Monica-Pass/Monica) ⭐ 1,023 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-21 - Local-first Bitwarden/KeePass password vault with TOTP; Shizuku keeps autofill protection running in the background. `GPL-3.0`
...
* [PrivacyFlip](https://f-droid.org/packages/io.github.dorumrr.privacyflip/) - Manage your device privacy based on lock/unlock state `MIT` [(Source code)](https://github.com/dorumrr/privacyflip) ⭐ 303 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-16
...
* [AppOpsNext](https://github.com/1zumiii/AppOpsNext) ⭐ 37 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - Android 15+ AppOps manager with permission templates, batch changes, install history and diagnostics via Shizuku `Proprietary`

### Productivity

* [Curbox](https://f-droid.org/packages/neth.iecal.curbox/) ✨ - Tool to reduce screen addiction and view usage analytics `GPL-3.0` [(Source code)](https://github.com/curbox-app/curbox-android) ⭐ 1,353 | 🐛 33 | 🌐 Kotlin | 📅 2026-09-15
...
* [DetoxDroid](https://github.com/flxapps/DetoxDroid) ⭐ 523 | 🐛 38 | 🌐 Kotlin | 📅 2026-09-20 - Digital Detoxing: Use your phone rather than letting your phone use you `GPL-3.0`
* [Cresto](https://github.com/Nevodev/Cresto) ⭐ 313 | 🐛 9 | 🌐 Kotlin | 📅 2026-09-04 - To-do app with AI capture, calendar sync and reminders; its Quick Settings current-screen extraction captures the screen through Shizuku shell access. `Apache-2.0`
* [HyperCopy](https://github.com/1812z/HyperCopy) ⭐ 183 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-05 - Clipboard-to-app jump tool watching copied links and opening them directly in the right app via Shizuku or LSPosed monitoring. `Proprietary`
...
* [quickdash](https://github.com/Balajitechlabs/quickdash) ⭐ 21 | 🐛 8 | 🌐 Kotlin | 📅 2026-09-20 - Floating productivity dashboard with UPI/PayPal collection and chat shortcuts; a Shizuku bridge unlocks privileged system capabilities. `Proprietary`
...
* [Quick-Tile Settings](https://f-droid.org/packages/com.rbn.qtsettings/) - QS tiles for toggling USB debugging and switching private DNS hosts `GPL-3.0` [(Source code)](https://github.com/RBN-Apps/Quick-Tile-Settings) ⭐ 391 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-21
...
* [Private DNS Quick Setting](https://apt.izzysoft.de/fdroid/index/apk/com.flashsphere.privatednsqs) - QS tile for toggling the private DNS setting on or off `GPL-3.0` [(Source code)](https://github.com/flashsphere/private-dns-qs) ⭐ 133 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,723 | 🐛 170 | 🌐 Kotlin | 📅 2026-09-17
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,929 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-17
* [Island](https://play.google.com/store/apps/details?id=com.oasisfeng.island) - Isolate and clone apps for privacy protection and parallel running `Apache-2.0` [(Source code)](https://github.com/oasisfeng/island) ⭐ 3,931 | 🐛 682 | 🌐 Java | 📅 2025-04-24
...
* [MMRL](https://github.com/MMRLApp/MMRL) ⭐ 2,165 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-18 `Root` - Manage your Magisk module repository `GPL-3.0`
* [Inure App Manager](https://play.google.com/store/apps/details?id=app.simple.inure.play) `15-day trial` `IAP` 💰 - Android app manager for both rooted and non-rooted devices `GPL-3.0` [(Source code)](https://github.com/Hamza417/Inure) ⭐ 1,924 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-19
* [UpgradeAll](https://f-droid.org/packages/net.xzos.upgradeall/) - Check updates for Android apps, Magisk modules and more! `GPL-3.0` [(Source code)](https://github.com/DUpdateSystem/UpgradeAll) ⭐ 1,342 | 🐛 45 | 🌐 Kotlin | 📅 2026-09-18
* [Package Manager](https://play.google.com/store/apps/details?id=com.smartpack.packagemanager) - A powerful app to manage both system and user apps `GPL-3.0` [(Source code)](https://github.com/SmartPack/PackageManager) ⭐ 829 | 🐛 72 | 🌐 Java | 📅 2026-08-25
* [Thor](https://play.google.com/store/apps/details?id=com.valhalla.thor) - App manager with freeze and install capabilities. `GPL-3.0` [(Source code)](https://github.com/trinadhthatakula/Thor) ⭐ 567 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-21
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 258 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-21 - An app manager focusing on permission management `GPL-3.0`
...
* [AppVaultX](https://github.com/sunilpaulmathew/AppVaultX) ⭐ 144 | 🐛 7 | 🌐 Java | 📅 2026-05-19 - High-performance app manager powered by Shizuku `GPL-3.0`
...
* [AppManagerNG](https://github.com/SysAdminDoc/AppManagerNG) ⭐ 91 | 🐛 6 | 🌐 Java | 📅 2026-09-14 - Fork of [AppManager](https://github.com/muntashirakon/appmanager) ⭐ 9,033 | 🐛 195 | 🌐 Java | 📅 2026-09-20 to inspect, debloat, back up, freeze and control Android apps; works with Shizuku, ADB, Dhizuku or root. `GPL-3.0`
...
* [DroidUtility](https://github.com/DroidUtility/DroidUtility) ⭐ 17 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-11 - Non-root utility suite for debloating, system tweaks and privileged shell execution through Shizuku, aimed at mobile-only developers. `MIT`
...
* [TaskManager](https://github.com/RohitKushvaha01/TaskManager) ⭐ 645 | 🐛 5 | 🌐 C++ | 📅 2026-09-17 - A Task Manager for Android. Killing processes requires root access. `Apache-2.0`
...
* [Running Services Monitor](https://play.google.com/store/apps/details?id=me.biplobsd.rsm) - Monitor running services on your Android device `MIT` [(Source code)](https://github.com/biplobsd/running_services_monitor) ⭐ 429 | 🐛 6 | 🌐 Dart | 📅 2026-07-12
...
* [KillMyApps](https://github.com/dedeadend/KillMyApps) ⭐ 96 | 🐛 0 | 🌐 Java | 📅 2026-09-15 - Background process killer to improve battery life and performance via Shizuku or root `GPL-3.0`
...
* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,223 | 🐛 55 | 🌐 Kotlin | 📅 2026-09-20
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,379 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-21 - Material You Redesign of aShell app. `GPL-3.0`
...
* [Smartspacer](https://github.com/KieronQuinn/Smartspacer) ⭐ 3,525 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-29 - Customizable widget, can upgrade the built-in 'At a glance' widget on Pixel devices using Shizuku `GPL-3.0`
...
* [carrier-ims-for-pixel](https://github.com/ryfineZ/carrier-ims-for-pixel) ⭐ 1,722 | 🐛 138 | 🌐 Kotlin | 📅 2026-07-04 - Maintained Pixel IMS toolkit: tune VoLTE/VoWiFi/VoNR, 5G display and carrier config via Shizuku `Apache-2.0`
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 393 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-13 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [hilight-studio](https://github.com/DhananjayBhosale/hilight-studio) ⭐ 326 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-19 - Pixel 11 HiLight LED controller for custom notification and status light effects `MIT`
...
* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 1,255 | 🐛 534 | 🌐 Kotlin | 📅 2026-09-03 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
* [SamsungRegionOverride](https://github.com/Ritel-T/SamsungRegionOverride) ⭐ 62 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-10 - Temporarily change the SIM region seen by Galaxy Store and other region-locked apps, no root, one-tap restore `MIT`
* [ScamsungFonts](https://github.com/KhunHtetzNaing/ScamsungFonts) ⭐ 37 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-03 - Font manager for Samsung Galaxy (OneUI) via System shell or Root `No license`
...
* [IslandRecorder](https://github.com/wxxsfxyzm/IslandRecorder) ⭐ 112 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-29 - Xiaomi-focused screen recorder with Super Island controls `GPL-3.0`
* [HyperOS FCM Fix](https://github.com/dingwen07/hyperos-fcm-fix) ⭐ 111 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-01 - Keeps Google Play services unrestricted on HyperOS so FCM push notifications arrive on time `GPL-3.0`
...
* [Aura](https://github.com/tgvdufuture/Aura) ⭐ 6 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - Custom RGB notification LED app for POCO X8 Pro with per-app, per-contact, and per-group colors and animations `MIT`
...
* [Calibrate-SoC](https://github.com/mayusi/Calibrate-SoC) ⭐ 12 | 🐛 0 | 🌐 Kotlin | 📅 2026-09-21 - SoC tuner, monitor and benchmark suite for Android gaming handhelds with goal-seeking governor and live HUD. `Apache-2.0`
...
> \[!NOTE]
> I'm also using an automated crawler that searches for new projects, making use of Shizuku across GitHub and several F-Droid repos. You can view the [current auto-generated crawl report here](https://github.com/timschneeb/app-crawler/blob/master/SUMMARY.md) ⭐ 83 | 🐛 6 | 🌐 Python | 📅 2026-09-21.
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,575 | 🐛 330 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
...
* [Porter API](https://github.com/d4rken-org/porter-api) ⭐ 2 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-21 - Android SDK for Porter, a maintained Shizuku fork, offering compatible Shizuku APIs with direct Porter support `MIT`
...
* [AndroSH](https://github.com/ahmed-alnassif/AndroSH) ⭐ 251 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - No-Root Multi-Distro Linux on Android via Shizuku/ADB - Run Arch, Fedora, Alpine, Debian, Ubuntu, Kali, Void, Manjaro, OpenSUSE & Chimera with full system integration, proot isolation & Termux:X11 GUI `GPL-3.0`
