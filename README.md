...
[![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,904 | 🐛 105 | 📅 2026-08-21
...
> \[!NOTE]
> To stay up-to-date with this list, [you can check the daily changelogs](https://github.com/timschneeb/changelog-awesome-shizuku) ⭐ 93 | 🐛 0 | 📅 2026-08-31.
...
* [Operit AI](https://github.com/AAswordman/Operit) ⭐ 7,454 | 🐛 96 | 🌐 Kotlin | 📅 2026-09-01 - The most powerful AI agent and AI chat software on Android. Can run commands using Shizuku `LGPL-3.0`
* [OpenMinis](https://github.com/OpenMinis/OpenMinis) ⭐ 4,095 | 🐛 145 | 🌐 Swift | 📅 2026-08-18 - AI-powered agent with Linux shell, browser automation, and system control via Shizuku `GPL-3.0`
* [OmniBot](https://github.com/omnimind-ai/OmniBot) ⭐ 1,950 | 🐛 24 | 🌐 Dart | 📅 2026-08-31 - On-device AI agent with terminal, web browsing, device control, and system integration `GPL-3.0`
...
* [flicky](https://apt.izzysoft.de/fdroid/index/apk/app.flicky) - An F-Droid client designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/flicky) ⭐ 421 | 🐛 16 | 🌐 Kotlin | 📅 2026-08-31
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer designed for Android TVs `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 188 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29
...
* [RootlessJamesDSP](https://play.google.com/store/apps/details?id=me.timschneeberger.rootlessjamesdsp) - An implementation of the system-wide JamesDSP audio processing engine for non-rooted Android devices `GPL-3.0` [(Source code)](https://github.com/timschneeb/RootlessJamesDSP) ⭐ 1,653 | 🐛 139 | 🌐 C | 📅 2026-08-31
* [VolumeManager](https://github.com/yume-chan/VolumeManager) ⭐ 547 | 🐛 19 | 🌐 Kotlin | 📅 2026-05-19 - Control each app's volume independently `GPL-2.0`
...
* [AutoJs6](https://github.com/SuperMonster003/AutoJs6) ⭐ 6,300 | 🐛 340 | 🌐 Java | 📅 2026-03-16 - JavaScript-based automation tool `MPL-2.0`
* [Geto](https://github.com/JackEblan/Geto) ⭐ 1,170 | 🐛 25 | 🌐 Kotlin | 📅 2026-07-29 - Automatically change device settings when a specific app is launched. `GPL-3.0`
...
* [ShizuCallRecorder](https://github.com/kitsumed/ShizuCallRecorder) ⭐ 1,370 | 🐛 15 | 🌐 Kotlin | 📅 2026-08-29 ✨ - ShizuCallRecorder empowers ADB through Shizuku to record phone calls on non-rooted device! `GPL-3.0`
...
* [essentials](https://github.com/sameerasw/essentials) ⭐ 2,816 | 🐛 90 | 🌐 Kotlin | 📅 2026-09-01 ✨ - Essential tools, mods and workarounds for Pixels. Also compatible with other devices `MIT`
* [AmbientMusicMod](https://github.com/KieronQuinn/AmbientMusicMod) ⭐ 2,501 | 🐛 10 | 🌐 Kotlin | 📅 2024-09-07 - Port of Now Playing from Pixels to other Android devices `GPL-3.0`
* [ShizuTools](https://github.com/legendsayantan/ShizuTools) ⭐ 2,480 | 🐛 30 | 🌐 Kotlin | 📅 2026-07-28 - Contains some easy-to-use tools to go beyond the level of control allowed by Android System `GPL-3.0`
* [ColorBlendr](https://github.com/Mahmud0808/ColorBlendr) ⭐ 2,421 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-30 - An application to modify Material You colors of your device `GPL-3.0`
* [LinkSheet](https://github.com/LinkSheet/LinkSheet) ⭐ 2,088 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-07 - Restore the Android <12 Url-App-Link-Chooser with Material3 `Modified MPL-2.0`
...
* [YoukiDEX](https://github.com/mrYouki/YoukiDex-Android-Desktop) ⭐ 553 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-21 - A full desktop experience layer for Android `GPL-3.0`
...
* [Smart Edge](https://f-droid.org/en/packages/com.imi.smartedge.sidebar.panel/) - A highly customizable Android side panel inspired by OriginOS `MIT` [(Source code)](https://github.com/Imtiaz-Official/Smart-Edge) ⭐ 326 | 🐛 41 | 🌐 Kotlin | 📅 2026-06-13
...
* [Adaptive-Theme](https://play.google.com/store/apps/details?id=dev.lexip.hecate) - Smart dark mode based on ambient light `GPL-3.0` [(Source code)](https://github.com/xLexip/Adaptive-Theme) ⭐ 215 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-31
...
* [Smart Island](https://github.com/agupta07505/SmartIsland) ⭐ 133 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-29 - A lightweight Android overlay that turns notifications, calls, and media playback into a floating glanceable island `GPL-3.0`
...
* [LibChecker](https://github.com/LibChecker/LibChecker) ⭐ 7,122 | 🐛 18 | 🌐 Kotlin | 📅 2026-08-31 - An app to view libraries used in apps on your device. Uses Shizuku to determine the installation source of other apps. `Apache-2.0`
* [DSU-Sideloader](https://github.com/VegaBobo/DSU-Sideloader) ⭐ 2,274 | 🐛 128 | 🌐 Kotlin | 📅 2024-03-13 - A simple app made to help users easily install GSIs via DSU's Android feature. `Apache-2.0`
...
* [ActivityManager](https://github.com/sdex/ActivityManager) ⭐ 1,299 | 🐛 15 | 🌐 Kotlin | 📅 2026-07-25 - Launch hidden and unexported activities directly without root `Apache-2.0`
* [LogFox](https://github.com/F0x1d/LogFox) ⭐ 1,291 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-27 ✨ - Yet another logcat reader for Android `GPL-3.0`
* [Cosmic-IDE](https://github.com/aload0/Cosmic-IDE) ⭐ 724 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-21 - IDE for JVM development. Uses Shizuku for an embedded shell `GPL-3.0`
...
* [RootActivityLauncher](https://play.google.com/store/apps/details?id=tk.zwander.rootactivitylauncher) `Paid` 💰 - Launch/interact with (un)exported activities, services, and receivers. Supports Shizuku alongside root. `GPL-3.0` [(Source code)](https://github.com/zacharee/RootActivityLauncher) ⭐ 288 | 🐛 6 | 🌐 Kotlin | 📅 2025-09-29
* [CurrentActivity](https://github.com/Omico/CurrentActivity) ⭐ 281 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-27 - A current activity monitor `GPL-3.0`
* [FrameX-Android](https://github.com/MaheshSharan/FrameX-Android) ⭐ 132 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-01 - Real-time performance overlay for Android `MIT`
...
* [Dhizuku](https://github.com/iamr0s/Dhizuku) ⭐ 3,767 | 🐛 20 | 🌐 Kotlin | 📅 2026-08-31 - Shizuku-inspired app that allows sharing DeviceOwner permissions to third-party apps `GPL-3.0`
* [OwnDroid](https://github.com/BinTianqi/OwnDroid) ⭐ 1,354 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-01 - Manage your device with Device owner privileges `GPL-3.0`
  * [MDPC](https://github.com/MrRare2/MDPC) ⭐ 116 | 🐛 0 | 🌐 Kotlin | 📅 2026-03-13 - Fork of OwnDroid with added features `GPL-3.0`
* [harbor](https://f-droid.org/packages/com.monstera.harbor/) - Work-profile manager with optional Shizuku tools for automation `Apache-2.0` [(Source code)](https://github.com/Stem0794/harbor) ⭐ 29 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-26
...
* [Dextop](https://github.com/NarYuki/Dextop) ⭐ 186 | 🐛 2 | 🌐 Dart | 📅 2026-08-26 - Desktop environment using Samsung DeX or Shizuku with multitasking and custom resolution `GPL-3.0`
...
* [Mihon](https://github.com/mihonapp/mihon) ⭐ 23,281 | 🐛 726 | 🌐 Kotlin | 📅 2026-08-30 - Manga reader using Shizuku plugin management. Independent successor of Tachiyomi. `Apache-2.0`
  * Mihon/Tachiyomi has several other active forks, including [TachiyomiSY](https://github.com/jobobby04/TachiyomiSY) ⭐ 4,128 | 🐛 315 | 🌐 Kotlin | 📅 2026-08-27 and [TachiyomiAZ](https://github.com/az4521/TachiyomiAZ) ⭐ 728 | 🐛 22 | 🌐 Kotlin | 📅 2026-08-28
* [Aniyomi](https://github.com/aniyomiorg/aniyomi) ⭐ 7,642 | 🐛 375 | 🌐 Kotlin | 📅 2026-08-26 - Tachiyomi fork with anime support and plugin management using Shizuku. `Apache-2.0`
...
* [SDMaid-SE](https://play.google.com/store/apps/details?id=eu.darken.sdmse) `IAP` 💰 - SD Maid 2/SE is Android's most thorough cleaning tool `GPL-3.0` [(Source code)](https://github.com/d4rken-org/sdmaid-se) ⭐ 7,421 | 🐛 19 | 🌐 Kotlin | 📅 2026-09-01
* [NFile](https://github.com/Senzme/NFile) ⭐ 386 | 🐛 56 | 🌐 Dart | 📅 2026-08-11 - File manager with Android folder access using Shizuku `GPL-3.0`
* [fluffy](https://apt.izzysoft.de/fdroid/index/apk/app.fluffy) - An file manager and archive viewer with Android TV support. Supports full file access using Shizuku, if enabled in settings `GPL-3.0` [(Source code)](https://github.com/mlm-games/fluffy) ⭐ 188 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29
...
* [KeyMapper](https://play.google.com/store/apps/details?id=io.github.sds100.keymapper) ✨ - An Android app that changes what the buttons do on your devices! `GPL-3.0` [(Source code)](https://github.com/keymapperorg/KeyMapper) ⭐ 2,622 | 🐛 208 | 🌐 Kotlin | 📅 2026-09-01
...
* [Obtainium](https://github.com/ImranR98/Obtainium) ⭐ 19,371 | 🐛 395 | 🌐 Dart | 📅 2026-08-29 - Get Android App Updates Directly From the Source `GPL-3.0`
  * [ObtainX](https://f-droid.org/packages/dev.bikram.obtainx/) - Obtainium fork with Material 3 UI redesign `GPL-3.0` [(Source code)](https://github.com/bikram-agarwal/ObtainX) ⭐ 1,097 | 🐛 8 | 🌐 Dart | 📅 2026-08-31
* [GitHub-Store](https://f-droid.org/packages/zed.rainxch.githubstore/) - App store for GitHub releases with discovery function `Apache-2.0` [(Source code)](https://github.com/kurikomi-labs/komi-store) ⭐ 18,131 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-31
* [Droid-ify](https://f-droid.org/packages/com.looker.droidify/) - Material F-Droid client `GPL-3.0` [(Source code)](https://github.com/Droid-ify/client) ⭐ 7,349 | 🐛 196 | 🌐 Kotlin | 📅 2026-08-31
* [InstallerX-Revived](https://github.com/wxxsfxyzm/InstallerX-Revived) ⭐ 6,432 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-01 ✨ - Modern and functional Android app installer replacement `GPL-3.0`
* [Neo-Store](https://f-droid.org/packages/com.machiav3lli.fdroid/) - An F-Droid client with modern UI and an arsenal of extra features `GPL-3.0` [(Source code)](https://github.com/NeoApplications/Neo-Store) ⭐ 4,962 | 🐛 121 | 🌐 Kotlin | 📅 2026-08-31
* [SAI](https://f-droid.org/packages/com.aefyr.sai.fdroid/) - Android split APKs installer `GPL-3.0` [(Source code)](https://github.com/Aefyr/SAI) ⭐ 3,816 | 🐛 0 | 🌐 Java | 📅 2024-06-03
* [Orion Store](https://github.com/RookieEnough/Orion-Store) ⭐ 3,197 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-17 - App store for modded apps `GPL-3.0`
* [InstallWithOptions](https://github.com/zacharee/InstallWithOptions) ⭐ 3,194 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-27 - Simple-ish app using Shizuku to install APKs on-device with advanced options `MIT`
* [universal-installer](https://github.com/pass-with-high-score/universal-installer) ⭐ 1,344 | 🐛 18 | 🌐 Kotlin | 📅 2026-09-01 - Install and manage APK packages with split APK support, silent install via Shizuku, and VirusTotal malware scanning `GPL-3.0`
* [instafel](https://github.com/mamiiblt/instafel) ⭐ 1,255 | 🐛 13 | 🌐 Java | 📅 2026-08-21 - Updater app for Instafel, an Instagram mod `MIT`
...
* [florid](https://github.com/Nandanrmenon/florid) ⭐ 500 | 🐛 46 | 🌐 Dart | 📅 2026-09-01 - Material3 F‑Droid Client `GPL-3.0`
* [BHub](https://github.com/B1ays/BHub) ⭐ 357 | 🐛 4 | 🌐 Kotlin | 📅 2025-10-01 - Download, install and share mods easily `Proprietary`
* [ShizuCoreFetch](https://github.com/elhizazi1/ShizuCoreFetch) ⭐ 338 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - Shizuku-powered app manager with silent installs, updates, and batch operations `GPL-3.0`
...
* [sing-box](https://f-droid.org/packages/io.nekohasekai.sfa/) - Universal proxy platform. Uses Shizuku for per-app proxying `GPL-3.0` [(Source code)](https://github.com/SagerNet/sing-box) ⭐ 37,493 | 🐛 302 | 🌐 Go | 📅 2026-09-01
* [WG Tunnel](https://github.com/wgtunnel/android) ⭐ 3,099 | 🐛 110 | 🌐 Kotlin | 📅 2026-09-01 - A FOSS Android client for WireGuard and AmneziaWG with auto-tunneling. `MIT`
* [ShizuWall](https://github.com/AhmetCanArslan/ShizuWall) ⭐ 2,200 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-01 ✨ - Open-source app firewall that doesn't depend on VPNs or root `GPL-3.0`
...
* [ADNS](https://github.com/eyalm2000/adns) ⭐ 583 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-31 - DNS-based ad blocker for Android `MIT`
* [delta](https://github.com/supershadoe/delta) ⭐ 560 | 🐛 17 | 🌐 Kotlin | 📅 2026-05-02 - Hotspot manager using Shizuku `BSD-3-Clause`
* [NetworkSwitch](https://github.com/aunchagaonkar/NetworkSwitch) ⭐ 457 | 🐛 21 | 🌐 Kotlin | 📅 2026-08-20 - Android app for 4G/5G network mode switching `GPL-3.0`
* [de1984](https://github.com/dorumrr/de1984) ⭐ 396 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-29 - App firewall without using an VPN; can also manage packages `MIT`
...
* [Dolphy-App](https://github.com/unvoiddd/Dolphy-App) ⭐ 78 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-26 - NFC, BLE, and IR multi-tool for wireless protocol research `GPL-3.0`
* [Shizzi](https://github.com/carlelieser/shizzi) ⭐ 57 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-31 - Rootless Wi-Fi tethering bypass via Shizuku `Proprietary`
...
* [Morphe](https://morphe.software/) - User-friendly YouTube patcher based on Universal-ReVanced-Manager `GPL-3.0` [(Source code)](https://github.com/MorpheApp/morphe-manager) ⭐ 7,647 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-01
* [LSPatch](https://github.com/JingMatrix/LSPatch) ⭐ 3,787 | 🐛 9 | 🌐 Kotlin | 📅 2026-08-23 - A non-root Xposed framework extending from LSPosed `GPL-3.0`
* [Universal-ReVanced-Manager](https://github.com/Jman-Github/Universal-ReVanced-Manager) ⭐ 1,285 | 🐛 56 | 🌐 Kotlin | 📅 2026-08-29 - ReVanced patcher that has extra features the official manager doesn't have `GPL-3.0`
...
* [NoMoreBackground](https://f-droid.org/packages/com.adilhanney.no_more_background/) - A fire-and-forget program to stop Android apps from running in the background `GPL-3.0` [(Source code)](https://github.com/adil192/no_more_background) ⭐ 311 | 🐛 9 | 🌐 Dart | 📅 2026-08-06
...
* [RebootNya](https://github.com/daisukiKaffuChino/RebootNya) ⭐ 255 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20 - Advanced reboot menu with Shizuku support `Apache-2.0`
* [BatStats](https://github.com/mlm-games/BatStats) ⭐ 176 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-31 - Battery monitor with stats via Shizuku `GPL-3.0`
* [Battery-Monitor](https://github.com/tswistak/Battery-Monitor) ⭐ 72 | 🐛 40 | 🌐 Kotlin | 📅 2026-08-31 - Track and log battery capacity and parameters over time using Shizuku `GPL-3.0`
...
* [Amarok-Hider](https://apt.izzysoft.de/fdroid/index/apk/deltazero.amarok.foss) - Hide your private files and Android apps with just one click `Apache-2.0` [(Source code)](https://github.com/deltazefiro/Amarok-Hider) ⭐ 3,222 | 🐛 62 | 🌐 Java | 📅 2026-08-11
...
* [Curbox](https://f-droid.org/packages/neth.iecal.curbox/) ✨ - Tool to reduce screen addiction and view usage analytics `GPL-3.0` [(Source code)](https://github.com/curbox-app/curbox-android) ⭐ 1,273 | 🐛 36 | 🌐 Kotlin | 📅 2026-08-28
...
* [Quick-Tile Settings](https://f-droid.org/packages/com.rbn.qtsettings/) - QS tiles for toggling USB debugging and switching private DNS hosts `GPL-3.0` [(Source code)](https://github.com/RBN-Apps/Quick-Tile-Settings) ⭐ 373 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-27
...
* [Hail](https://f-droid.org/packages/com.aistra.hail/) ✨ - Freeze, hide, or disable any app. Create and organize app groups that can be frozen with one click. `GPL-3.0` [(Source code)](https://github.com/aistra0528/Hail) ⭐ 6,584 | 🐛 168 | 🌐 Kotlin | 📅 2026-08-29
* [Canta](https://play.google.com/store/apps/details?id=io.github.samolego.canta) - Uninstall any app without root `LGPL-3.0` [(Source code)](https://github.com/samolego/Canta) ⭐ 5,707 | 🐛 30 | 🌐 Kotlin | 📅 2026-08-31
* [Island](https://play.google.com/store/apps/details?id=com.oasisfeng.island) - Isolate and clone apps for privacy protection and parallel running `Apache-2.0` [(Source code)](https://github.com/oasisfeng/island) ⭐ 3,896 | 🐛 670 | 🌐 Java | 📅 2025-04-24
* [Blocker](https://github.com/lihenggui/blocker) ⭐ 2,380 | 🐛 46 | 🌐 Kotlin | 📅 2026-08-31 - Enable/disable Android components such as activities, services, receivers, and providers `Apache-2.0`
...
* [UpgradeAll](https://f-droid.org/packages/net.xzos.upgradeall/) - Check updates for Android apps, Magisk modules and more! `GPL-3.0` [(Source code)](https://github.com/DUpdateSystem/UpgradeAll) ⭐ 1,334 | 🐛 40 | 🌐 Kotlin | 📅 2026-09-01
...
* [Buge App Manager](https://github.com/BugeStudioTeam/Buge-App-Manager) ⭐ 199 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-30 - An app manager focusing on permission management `GPL-3.0`
...
* [memhogs](https://github.com/cicerothoma/memhogs-android) ⭐ 51 | 🐛 2 | 🌐 Kotlin | 📅 2026-07-04 - Which apps are eating your phone's memory. Per-app breakdown via Shizuku, helpers grouped under the app that owns them `MIT`

### Terminals

* [Haven](https://f-droid.org/packages/sh.haven.app/) - Terminal, SSH, VNC, RDP, SFTP & cloud storage client for Android `AGPL-3.0` [(Source code)](https://github.com/GlassHaven/Haven) ⭐ 1,141 | 🐛 57 | 🌐 Kotlin | 📅 2026-09-01
...
* [aShell](https://gitlab.com/sunilpaulmathew/ashell) - A local ADB shell for Shizuku-powered Android devices `GPL-3.0`
  * [aShell You](https://github.com/DP-Hridayan/aShellYou) ⭐ 2,278 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-01 - Material You Redesign of aShell app. `GPL-3.0`
...
* [pixel-volte-patch](https://github.com/kyujin-cho/pixel-volte-patch/blob/main/README.en.md) ⭐ 2,999 | 🐛 95 | 🌐 Kotlin | 📅 2026-02-07 - Enable VoLTE on Pixel 6 & 7 with LG U+ `GPL-3.0`
...
* [Root-My-Pixel](https://github.com/alex193a/Root-My-Pixel) ⭐ 241 | 🐛 22 | 🌐 Kotlin | 📅 2026-09-01 - Root automation for Pixel devices via CVE-2026-43499 exploit `Proprietary`
...
* [Root-My-Galaxy](https://github.com/BuSung-dev/Root-My-Galaxy) ⭐ 971 | 🐛 430 | 🌐 Kotlin | 📅 2026-08-24 - KSU installer for supported Samsung Galaxy firmware with CVE-2026-43499 `Apache-2.0`
...
* [ClusterTune](https://github.com/AurelioB/ClusterTune) ⭐ 292 | 🐛 11 | 🌐 Kotlin | 📅 2026-08-23 - Tune CPU cluster frequencies to balance performance and power on AYN handheld devices `GPL-2.0`
...
> \[!NOTE]
> I'm also using an automated crawler that searches for new projects, making use of Shizuku across GitHub and several F-Droid repos. You can view the [current auto-generated crawl report here](https://github.com/timschneeb/app-crawler/blob/master/SUMMARY.md) ⭐ 81 | 🐛 6 | 🌐 Python | 📅 2026-08-31.
...
* [Shizuku-API](https://github.com/RikkaApps/Shizuku-API) ⭐ 2,503 | 🐛 318 | 🌐 Java | 📅 2025-05-29 - Developer documentation for Shizuku and Sui, including examples `Apache-2.0`
